...
class PartnerwalletController extends Controller {
	...
	public $module = 'partnerwallet';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Partnerwallet();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'partnerwallet',
	...
	public static function display(  )
	{
		...
		$model  = new Partnerwallet();
		$info = $model::makeInfo('partnerwallet');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('partnerwallet.public.view',$data);			
			}			
		} 
		else {
			...
			return view('partnerwallet.public.index',$data);	
		}
