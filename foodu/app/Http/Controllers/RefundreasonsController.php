...
class RefundreasonsController extends Controller {
	...
	public $module = 'refundreasons';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Refundreasons();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'refundreasons',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('refundreasons');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('refundreasons.public.view',$data);			
			}			
		} 
		else {
			...
			return view('refundreasons.public.index',$data);	
		}
