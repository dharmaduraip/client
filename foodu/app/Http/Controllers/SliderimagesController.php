...
class SliderimagesController extends Controller {
	...
	{		
		parent::__construct();
		$this->model = new Sliderimages();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'sliderimages',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('sliderimages');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('sliderimages.public.view',$data);			
			}			
		} 
		else {
			...
			return view('sliderimages.public.index',$data);	
		}
