...
class RejectedordersController extends Controller {
	...
	public $module = 'rejectedorders';
	static $per_page	= '20';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Rejectedorders();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'rejectedorders',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('rejectedorders');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('rejectedorders.public.view',$data);			
			}			
		} 
		else {
			...
			return view('rejectedorders.public.index',$data);	
		}
