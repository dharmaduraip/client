...
class RefundinfoController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'refundinfo';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Refundinfo();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'refundinfo',
	...
	public static function display(  )
	{
		...
		$model  = new Refundinfo();
		$info = $model::makeInfo('refundinfo');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('refundinfo.public.view',$data);			
			}			
		} 
		else {
			...
			return view('refundinfo.public.index',$data);	
		}
