...
use App\Models\Delboyloghistory;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class DelboyloghistoryController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'delboyloghistory';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Delboyloghistory();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'delboyloghistory',
	...
	public static function display(  )
	{
		...
		$model  = new Delboyloghistory();
		$info = $model::makeInfo('delboyloghistory');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('delboyloghistory.public.view',$data);			
			}			
		} 
		else {
			...
			return view('delboyloghistory.public.index',$data);	
		}
