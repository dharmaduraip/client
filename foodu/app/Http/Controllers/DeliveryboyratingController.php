...
class DeliveryboyratingController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'deliveryboyrating';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Deliveryboyrating();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'deliveryboyrating',
	...
	public static function display(  )
	{
		...
		$model  = new Deliveryboyrating();
		$info = $model::makeInfo('deliveryboyrating');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('deliveryboyrating.public.view',$data);			
			}			
		} 
		else {
			...
			return view('deliveryboyrating.public.index',$data);	
		}
