...
use App\Models\Uesrrefunds;
use Illuminate\Http\Request;
use Illuminate\Pagination\LengthAwarePaginator as Paginator;
use Validator, Input, Redirect ; 


class UesrrefundsController extends Controller {

	protected $layout = "layouts.main";
	protected $data = array();	
	public $module = 'uesrrefunds';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Uesrrefunds();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'uesrrefunds',
	...
	public static function display(  )
	{
		...
		$model  = new Uesrrefunds();
		$info = $model::makeInfo('uesrrefunds');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('uesrrefunds.public.view',$data);			
			}			
		} 
		else {
			...
			return view('uesrrefunds.public.index',$data);	
		}
