...
class OffersettingController extends Controller {
	...
	public $module = 'offersetting';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Offersetting();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'offersetting',
	...
	public static function display(  )
	{
		...
		$model  = new Offersetting();
		$info = $model::makeInfo('offersetting');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('offersetting.public.view',$data);			
			}			
		} 
		else {
			...
			return view('offersetting.public.index',$data);	
		}
