...
class RestaurantratingController extends Controller {
	...
	public $module = 'restaurantrating';
	static $per_page	= '10';
	...
	public static function display(  )
	{
		...
		$model  = new Restaurantrating();
		$info = $model::makeInfo('restaurantrating');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('restaurantrating.public.view',$data);			
			}			
		} 
		else {
			...
			return view('restaurantrating.public.index',$data);	
		}
