...
class VariationsController extends Controller {
	...
	public $module = 'variations';
	static $per_page	= '50';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Variations();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'variations',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('variations');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('variations.public.view',$data);			
			}			
		} 
		else {
			...
			return view('variations.public.index',$data);	
		}
