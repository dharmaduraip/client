...
class FoodcategoriesController extends Controller {
	...
	public $module = 'foodcategories';
	static $per_page	= '10';

	public function __construct()
	{		
		parent::__construct();
		$this->model = new Foodcategories();	
		
		$this->info = $this->model->makeInfo( $this->module);	
		$this->data = array(
			'pageTitle'	=> 	$this->info['title'],
			'pageNote'	=>  $this->info['note'],
			'pageModule'=> 'foodcategories',
	...
	public static function display(  )
	{
		...
		$info = $model::makeInfo('foodcategories');
		$data = array(
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('foodcategories.public.view',$data);			
			}			
		} 
		else {
			...
			return view('foodcategories.public.index',$data);	
		}
