...
class ApprovalController extends Controller {
	...
	public function index( Request $request )
	{
		...
		$this->data['rowData'] = Approval::where('admin_status', 'waiting')->get();			
	...
	public static function display(  )
	{
		...
		if($mode == 'view')
		{
			...
			if($row)
			{
				...
				$data['id'] = $id;
				return view('approval.public.view',$data);			
			}			
		} 
		else {
			...
			return view('approval.public.index',$data);	
		}
	...
	{
		$update = Approval::where('id', $request->id)->update(['admin_status' => $request->status]);
		return $update;
	}
}
