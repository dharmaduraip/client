...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'partnerrequest?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> PartnerRequest</legend>
				           ...
				           >{{ $row['email'] }}</textarea> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <textarea name='shop_name' rows='5' id='shop_name' class='form-control form-control-sm '  
				           >{{ $row['shop_name'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					...
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
									  ...
									  <div class="form-group row  " >
										<label for="Is Accept" class=" control-label col-md-4 text-left"> Is Accept </label>
										<div class="col-md-6">
										  <input  type='text' name='is_accept' id='is_accept' value='{{ $row['is_accept'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("partnerrequest/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
