<div class="row dynamic-color">
          ...
          <div class="col-md-4 col-xs-4 col-lg-4">
            ...
            <div class="grey lighten-5"><span>#fff grey lighten-5</span></div>
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.dynamic-color .col-md-4 div').click(function(){
            var color = $(this).attr('class');
            //alert(color)
            <?php if($pos =='sidebar') { ?>

                $('#side-nav').removeClass();
                $('#side-nav').addClass('sidebar-compact '+ color );
               
                $.cookie("side-nav-color", color , {expires: 365, path: '/'});

            <?php } else { ?>
                var h1 = $('.page-header');
                var h2 = $('.sidebar-header');
                h1.removeClass()
                h2.removeClass()                
                h1.addClass( 'page-header '+color )    
                h2.addClass( 'sidebar-header ' +color )            
                $.cookie("header-nav-color", color , {expires: 365, path: '/'});
