		...
		<div class="col-md-12">
			...
			<fieldset><h6 class="mb-3 pb-2"> Offer</h6>					
				<div class="form-group row  " >
					...
					<div class="col-md-6">
						<input  type='text' name='offer_name' id='promo_name' value='' 
					...
					<div class="col-md-2">
										...
										<div class="form-group row  " >
											...
											<div class="col-md-6">
												...
												<input type='radio' name='promo_type' value ='amount' required  class='minimal-green' > Amount 

												<input type='radio' name='promo_type' value ='percentage' required class='minimal-green' > Percentage  
											</div> 
											<div class="col-md-2">
												...
												<div class="form-group row " id="Promo_Code"  >
													...
													<div class="col-md-6">
												   <input  type='text' name='promo_code' id='promo_code' value='{{$code}}' 
										...
										<div class="form-group row  " >
											...
											<div class="col-md-6">
												<input  type='text' name='offer_amt' id='offer_amt' value=''
												required     class='form-control form-control-sm ' /> 
											</div> 
											<div class="col-md-2">
										...
										<div class="form-group row  " >
											...
											<div class="col-md-6">
												<input  type='text' name='min_order_value' id='min_order_value' value=''class='form-control form-control-sm ' /> 
									...
									<div class="col-md-2">
												...
												<div class="form-group row  " >
													...
													<div class="col-md-6">
														...
														<input type='radio' name='offer_mode' value ='on' required class='minimal-green' > On 

														<input type='radio' name='offer_mode' value ='off' required  class='minimal-green' > Off  
													</div> 
													<div class="col-md-2">
