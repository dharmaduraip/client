	...
	<div class="table-container" > 	
		...
		<table class="table table-striped table-bordered" >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Customer', (isset($fields['cust_id']['language'])? $fields['cust_id']['language'] : array())) }}</td>
						<td>{{ $row->cust_id}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Vendor Price', (isset($fields['host_amount']['language'])? $fields['host_amount']['language'] : array())) }}</td>
						<td>{{ $row->host_amount}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Fixed Commission', (isset($fields['comsn_percentage']['language'])? $fields['comsn_percentage']['language'] : array())) }}</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Hiking Price', (isset($fields['hiking']['language'])? $fields['hiking']['language'] : array())) }}</td>
						<td>{{ $row->hiking}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Delivery Charge', (isset($fields['del_charge']['language'])? $fields['del_charge']['language'] : array())) }}</td>
						<td>{{ $row->del_charge}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Total Profit', (isset($fields['admin_camount']['language'])? $fields['admin_camount']['language'] : array())) }}</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Mode Of Payment', (isset($fields['delivery_type']['language'])? $fields['delivery_type']['language'] : array())) }}</td>
