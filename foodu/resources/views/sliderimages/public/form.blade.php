		 ...
		 {!! Form::open(array('url'=>'sliderimages', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> SliderImages</legend>
					...
					<input type='radio' name='status' value ='inactive' required @if($row['status'] == 'inactive') checked="checked" @endif class='minimal-green' > Inactive  
						...
						required     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='ext_url' id='ext_url' value='{{ $row['ext_url'] }}' 
