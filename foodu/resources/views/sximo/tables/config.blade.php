...
{!! Form::open(array('url'=>$action, 'class'=>'form-horizontal','id'=>'saveform' , 'parsley-validate'=>'','novalidate'=>' ')) !!}
			<div class="col-md-6 form-horizontal">
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="table_name" required="true" value="<?php if(isset($info->Name)) echo $info->Name;?>" class="form-control input-sm" >
					</div>
				</div>
				<div class="form-group">
					<label class="col-md-4"> Storage Engine </label>
					<div class="col-md-8">
						<select class="form-control input-sm" name="engine" required="true">
							@foreach($engine as $e)
			...
			<table class="table table-bordered" id="tables">
				...
				@foreach($columns as $column)
					<tr class="" id="field-{{ $column->Field }}">
						...
						<td>
							...
							<a href="{{ URL::TO('sximo/tables/tablefieldedit/'.$table.'?'.$info) }}" class="btn btn-sm" onclick="SximoModal(this.href,'Edit New Column : {{$column->Field}} '); return false;" ><i class="fa fa-pencil "></i></a>
				...
				@else
					<tr class="clone clonedInput">
						...
						<td><input type="text" name="fields[]" value="" class="form-control input-sm" required="true" ></td>
						<td>					
						...
						<input type="text" name="lenghts[]" value="" class="form-control input-sm" ></td>
						<td>                        

                        
                        <input type="text" name="defaults[]" class="form-control input-sm" />							
						</td>
