...
#icons h2.page-header{
   padding: 10px 20px ;
   border-bottom: solid 1px #eee;
   font-size: 24px;
   margin-bottom: 10px;
}
#icons .fontawesome-icon-list { text-align: center; }
#icons .fontawesome-icon-list a { font-size: 11px; color: #333; }
#icons .fontawesome-icon-list a i{ font-size: 16px; display: block; padding: 5px 0; }
</style>