...
<?php $formID = $row['formID'];?>
 		 ...
 		 {!! Form::open(array('url'=>'core/forms/field/'.$row['formID'], 'class'=>'form-vertical','files' => true , 'parsley-validate'=>'','novalidate'=>' ' ,'id'=>'formField')) !!}
...
<input type="hidden" name="is_new" value="<?php echo ($f['field'] =='' ? 'new' : 'update');?>" />
...
<div class="form-vertical row">
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Label / Title </label>
		<input type="text" class="form-control input-sm" name="label" required="true" value="<?php echo $f['label'];?>" />
  </div> 
		
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Field </label>
		<input type="text" class="form-control input-sm" name="field" required="true" value="<?php echo $f['field'];?>" @if($f['field'] !='') readonly="1" @endif />
  </div> 

   <div class="form-group col-md-6" >
    <label for="ipt" class=" control-label ">Tooltip </label>
  ...
  <div class="form-group col-md-6">
    <label for="ipt" class=" control-label "> Required </label>
	...
	?>
		<select name="required" id="required" class="form-control input-sm"  >
			<option value="0" <?php if($f['required'] == 1) echo 'selected="selected"';?>>No Required</option>
			<?php foreach($reqType as $item=>$val) { ?>
				<option value="<?php echo $item;?>" <?php if($f['required'] == $item) echo 'selected="selected"';?>><?php echo $val;?></option>
			<?php } ?>
		</select>
...
<div class="form-horizontal row">
  ...
  <div class="form-group standart-form file-upl"  style="display:none;">
	...
	<div class="col-md-8">
		<input name="path_to_upload" type="text" id="path_to_upload" class="form-control input-sm" value="<?php echo $f['option']['path_to_upload'];?>"/>
		<label class=""> 
			...
			if(form.parsley().isValid()){			
				var options = { 
					...
					success:       function showResponse(data)  {	
						$('.ajaxLoading').hide();
						$.get( '<?php echo url("core/forms/configuration/".$formID) ;?>', function( data ) {
