...
<h3> Version 5.1.7  ( Dec 1  , 2016 )  </h3>
    <ol>  
      <li> Changed : Backend Template  </li>
      <li> Added : New Frontend Template </li>
      <li> Added : RestApi Client Editor </li>
      <li> Added : New Frontend Template </li>
      <li> Fixed : Username Field on registration  </li>
      <li> Fixed : Send Email system using Swift Mail  </li>
      <li> Enhance : Some translation layout  </li>
      <li> Fixed : Subform validation , subform access , subform update  </li>
      <li> Enhance : Script at sixmo.php model support up to 1 million rows  </li>
      
       <li> Enhance : Foreign key master detail , not have to be same  </li>
       <li> Enhance : Filter Limit rows Download Option ( Ajax Plugins )  </li>
       <li> added : Download PDF ( Ajax Plugins )  </li>
       <li> added : Print Page on view detail  ( Ajax Plugins )</li>
      <li> Fixed : error when submit empty value for multiselect  ( Ajax Plugins )</li>
      <li> Fixed : multiupload validation for image and files </li>
      
    </ol>

<h3> Version 5.1.6   ( Oct 10 , 2016 )  </h3>
    <ol>  
      <li> Copy/Clone Module </li>
      <li> Fixed : unformated reset password page </li>
      <li> Fixed : unordered view and form </li>
     <li> Added : Formatter for multiple select with database </li>
      <li> Added : Prev and Next row on view detail and form </li>
      <li> Added : New method onSearch() </li>
      <li> Fixed : Auto insert CreatedOn and UpdatedOn </li>
      <li> Enhancement : Notification page </li>
      <li> New Static Page system <sup class="badge badge-danger"> Beta  </sup></li>
      <li> Integrated Post/Article system <sup class="badge badge-danger"> Beta  </sup></li>
    
    <li> Form Generator <sup class="badge badge-danger"> Beta </sup></li>
    </ol>  


<h3> Version 5.1.5   ( May 25 , 2016 )  </h3>
    <ol>  
      <li> Fix Issue at filemanager   </li>
      <li> Enhance : Template </li>
      <li> Add Expand view detail at master detail </li>
      <li> New : Separator Menu  </li>
    </ol> 
    

<h3> Version 5.1.4  Revision Version ( May 2 , 2016 )  </h3>
    <ol>  
  ...
  <h3> Version 5.1.4  Reload Changelog ( April 15 , 2016 )  </h3>
  <ol> 
  ...
  <h3> Version 5.1.4  Changelog ( April 5 , 2016 )  </h3>
    <ol>
  ...
  <h3> Version 5.1.3  Changelog ( August 17 , 2015 )  </h3>
    <ol>
  ...
  <h3> Version 5.1.2  Changelog ( July 28 , 2015 )  </h3>
    <ol>
  ...
  <h3> Version 5.1.1  Changelog ( July 4 , 2015 )  </h3>
    <ol>
  ...
  <h3> Version 5.1 LTS Changelog </h3>
    <ol>
