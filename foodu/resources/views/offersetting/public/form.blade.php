		 ...
		 {!! Form::open(array('url'=>'offersetting', 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) !!}
...
<div class="col-md-12">
						<fieldset><legend> Offersetting</legend>
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					...
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
									  ...
									  <div class="form-group row  " >
										<label for="Offer Type" class=" control-label col-md-4 text-left"> Offer Type </label>
										<div class="col-md-6">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Offer Value" class=" control-label col-md-4 text-left"> Offer Value </label>
										<div class="col-md-6">
					...
					<input type='radio' name='status' value ='inactive'  @if($row['status'] == 'inactive') checked="checked" @endif class='minimal-green' > Inactive  
									  ...
									  <div class="form-group row  " >
										<label for="Usage Type" class=" control-label col-md-4 text-left"> Usage Type </label>
										<div class="col-md-6">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Usage Value" class=" control-label col-md-4 text-left"> Usage Value </label>
										<div class="col-md-6">
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Usage From" class=" control-label col-md-4 text-left"> Usage From </label>
										<div class="col-md-6">
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					...
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
									  ...
									  <div class="form-group row  " >
										<label for="Usage To" class=" control-label col-md-4 text-left"> Usage To </label>
										<div class="col-md-6">
				...
				<div class="input-group input-group-sm m-b" style="width:150px !important;">
					...
					<div class="input-group-append">
					 	<div class="input-group-text"><i class="fa fa-calendar"></i></span></div>
									  ...
									  <div class="form-group row  " >
										<label for="Offer Limit" class=" control-label col-md-4 text-left"> Offer Limit </label>
										<div class="col-md-6">
