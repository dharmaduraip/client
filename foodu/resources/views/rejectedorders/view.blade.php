...
<div class="toolbar-nav">
	<div class="row">
		<div class="col-md-6 ">
			@if($access['is_add'] ==1)
	   		<a href="{{ url('rejectedorders/'.$id.'/edit?return='.$return) }}" class="tips btn btn-default btn-sm  " title="{{ __('core.btn_edit') }}"><i class="fa  fa-pencil"></i></a>
			@endif
			<a href="{{ url('rejectedorders?return='.$return) }}" class="tips btn btn-default  btn-sm  " title="{{ __('core.btn_back') }}"><i class="fa  fa-times"></i></a>		
		</div>
		<div class="col-md-6 text-right">			
	   		<a href="{{ ($prevnext['prev'] != '' ? url('rejectedorders/'.$prevnext['prev'].'?return='.$return ) : '#') }}" class="tips btn btn-default  btn-sm"><i class="fa fa-arrow-left"></i>  </a>	
			<a href="{{ ($prevnext['next'] != '' ? url('rejectedorders/'.$prevnext['next'].'?return='.$return ) : '#') }}" class="tips btn btn-default btn-sm "> <i class="fa fa-arrow-right"></i>  </a>					
		</div>	
	...
	<div class="table-responsive">
		<table class="table table-striped table-bordered " >
			<tbody>	
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Ordered Time', (isset($fields['time']['language'])? $fields['time']['language'] : array())) }}</td>
						<td>{{ $row->time}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Cust Name', (isset($fields['cust_id']['language'])? $fields['cust_id']['language'] : array())) }}</td>
						<td>{{ $row->cust_id}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Cust Mobile ', (isset($fields['mobile_num']['language'])? $fields['mobile_num']['language'] : array())) }}</td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Time', (isset($fields['delivery_time']['language'])? $fields['delivery_time']['language'] : array())) }}</td>
						<td>{{ $row->delivery_time}} </td>
						
					</tr>
				
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Payment Status', (isset($fields['delivery']['language'])? $fields['delivery']['language'] : array())) }}</td>
						<td>{{ $row->delivery}} </td>
					...
					<tr>
						<td width='30%' class='label-view text-right'>{{ SiteHelpers::activeLang('Accept Coupon Price', (isset($fields['accept_coupon_price']['language'])? $fields['accept_coupon_price']['language'] : array())) }}</td>
						<td>{{ $row->accept_coupon_price}} </td>
