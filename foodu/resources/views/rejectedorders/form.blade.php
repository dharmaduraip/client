...
<div class="page-header"><h2> {{ $pageTitle }} <small> {{ $pageNote }} </small> </h2></div>
	...
	{!! Form::open(array('url'=>'rejectedorders?return='.$return, 'class'=>'form-horizontal validated sximo-form','files' => true ,'id'=> 'FormTable' )) !!}
	...
	<div class="p-5">
		...
		<div class="row">
	<div class="col-md-12">
						<fieldset><legend> Rejected Orders</legend>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										<label for="Accept Coupon Price" class=" control-label col-md-4 text-left"> Accept Coupon Price </label>
										<div class="col-md-6">
										  <textarea name='accept_coupon_price' rows='5' id='accept_coupon_price' class='form-control form-control-sm '  
				           >{{ $row['accept_coupon_price'] }}</textarea> 
										 </div> 
										 <div class="col-md-2">
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$('.removeMultiFiles').on('click',function(){
			var removeUrl = '{{ url("rejectedorders/removefiles?file=")}}'+$(this).attr('url');
			$(this).parent().remove();
