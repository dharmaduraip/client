...
<div class="toolbar-nav" >   
	<div class="sbox-title"> 
		...
		<div class="sbox-tools">
			...
			<a href="{{ URL::to('partners') }}" style="display: block ! important;" class="btn btn-xs btn-white tips" title="Clear Search" >
				 {!! "Back to Partner" !!} 
			</a>
			@endif
	...
	<div class="row d-none">
		<div class="col-md-8"> 	
			@if($access['is_add'] ==1)
			<a href="{{ url('partnerwallet/create?return='.$return) }}" class="btn  btn-sm"  
...
<div class="p-3">	
		<div class="table-container for-icon m-0">
			...
			<!-- Table Grid -->
 			...
 			{!! Form::open(array('url'=>'partnerwallet?'.$return, 'class'=>'form-horizontal m-t' ,'id' =>'SximoTable' )) !!}
							...
							<td>
							 	...
							 	<div class="dropdown">
								  ...
								  <ul class="dropdown-menu">
									...
									<li class="nav-item"><a href="{{ url('partnerwallet/'.$row->id.'?return='.$return)}}" class="nav-link tips" title="{{ __('core.btn_view') }}"> {{ __('core.btn_view') }} </a></li>
									@endif
									@if($access['is_edit'] ==1)
									<li class="nav-item"><a  href="{{ url('partnerwallet/'.$row->id.'/edit?return='.$return) }}" class="nav-link  tips" title="{{ __('core.btn_edit') }}"> {{ __('core.btn_edit') }} </a></li>
									@endif
									<div class="dropdown-divider"></div>
									@if($access['is_remove'] ==1)
										<li class="nav-item"><a href="javascript://ajax"  onclick="SximoDelete();" class="nav-link  tips" title="{{ __('core.btn_remove') }}">
