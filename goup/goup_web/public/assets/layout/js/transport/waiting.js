            ...
            <div id="ride-status" className="tab-pane active col-sm-12 col-md-12 col-lg-12">
                <div className="status-section bg-white p-3">
                    <div className="w-100" id="booking-status">
                        <div className="row dis-row align-items-start">
                                ...
                                <h5 className="text-left">Status {/* <span className="pull-right font-12 c-pointer txt-yellow dis-row"> <i className="material-icons mr-1">my_location</i> Track</span> */}</h5>
                                    <div className="col-md-12 col-lg-12 col-sm-12">
                                        ...
                                        <div class="row align-items-center">
                                            <div className="col-md-8 status mt-4">
                                                <h6>{rideStatus}</h6>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <span onClick={this.handleEmergencyModal} data-toggle="modal" data-target="#emergencyModal" style={{marginBottom: '10px'}} className="c-pointer txt-yellow dis-row mt-2"> <i className="material-icons">phone</i> Emergency Contact</span>
                                            </div>
                                        </div>
                                            <div className="trip-user dis-ver-center row mb-4">
                                                ...
                                                <div className="dis-column col-lg-6 col-md-6 col-sm-6 p-0">
                                                    ...
                                                    <h5>{ this.props.request.service_type ? this.props.request.service_type.vehicle.vehicle_no : "" } </h5>
                                                    <div className="rating-outer">
                        ...
                        <a className="btn btn-primary "  onClick={this.handleSendMessage} > <i className="fa fa-paper-plane" aria-hidden="true"></i></a>
                            ...
                            <div className="col-md-6 col-sm-6 col-lg-6">
                                ...
                                <div>
                                    ...
                                    { this.props.request.is_drop_location == 1 ? <img className="img-fluid" style={{ boxShadow: "2px 2px 10px #ccc" }} src={ "https://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=620x380&maptype=terrian&format=png&visual_refresh=true&markers=icon:"+window.url+"/assets/layout/images/common/marker-start.png%7C"+this.props.request.s_latitude+","+this.props.request.s_longitude+"&markers=icon:"+window.url+"/assets/layout/images/common/marker-end.png%7C"+this.props.request.d_latitude+","+this.props.request.d_longitude+"&path=color:0x191919|weight:3|enc:" + this.props.request.route_key + "&key=" + getSiteSettings().site.browser_key } /> : '' }
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <form>
                                            ...
                                            <div className="trip-user dis-ver-center col-lg-12 col-md-12 col-sm-12 mb-4">
                                                ...
                                                <div className="dis-column col-lg-6 col-md-6 col-sm-6 p-0">
                                                    ...
                                                    <h5>
                                                        { this.props.request.service_type ? this.props.request.service_type.vehicle.vehicle_no : "" }
                                                    </h5>
                                                    <div className="rating-outer">
                                                        <p style={{ cursor: "default" }}  >
                                                            { this.props.request.ride.vehicle_name }
                    ...
                    <div className="message-typing">
                        ...
                        <a className="btn btn-primary "  onClick={this.handleSendMessage} > <i className="fa fa-paper-plane" aria-hidden="true"></i></a>
                            ...
                            <div className="col-md-6 col-sm-6 col-lg-6">
                                ...
                                <div>
                                {this.props.request.is_drop_location == 1 ? <div id="track_map" style={{ width: "100%", height: "auto" }} ><img class="img-fluid" style={{ boxShadow: "2px 2px 10px #ccc" }} src={ "https://maps.googleapis.com/maps/api/staticmap?autoscale=1&size=620x380&maptype=terrian&format=png&visual_refresh=true&markers=icon:"+window.url+"/assets/layout/images/common/marker-start.png%7C"+this.props.request.s_latitude+","+this.props.request.s_longitude+"&markers=icon:"+window.url+"/assets/layout/images/common/marker-end.png%7C"+this.props.request.d_latitude+","+this.props.request.d_longitude+"&path=color:0x191919|weight:3|enc:" + this.props.request.route_key + "&key=" + getSiteSettings().site.browser_key } /></div> : '' }
                                </div>
                            </div>
                        </div>
                    </div>
...
class InvoiceComponent extends React.Component {
    ...
    handlePayment = () => {
        ...
        $.ajax({
            ...
            success: (data, textStatus, jqXHR) => {
                ...
                if(data.message.payment_mode == 'paypal'){
                ...
                }else if(data.message.payment_mode == 'NOWPAYMENT'){
                    if(data.message.data.url != null) {
                        location.assign(data.message.data.url);
                    } else {
                        hideLoader();
                        alertMessage('Error', data.message, "danger");
                    }
    ...
    handleRating = e => {
        ...
        let admin_service = this.props.request.service_type ? this.props.request.service_type.admin_service : "TRANSPORT";
                ...
                <div className="col-md-12 col-sm-12 col-lg-12 p-0 payment_invoice">
                    <form id="ride_creation">
                        <dl className="dl-horizontal left-right mt-5">
                            ...
                            {this.props.request.total_distance ? (
                                <span>
                                    <dt>Total Distance</dt>
                                    <dd>{(this.props.request.total_distance).toFixed( 2 )} {this.props.request.unit}</dd>
                                </span>
                            ) : ( "" )}

                            {this.props.request.payment ? (
                                <span>
                                    <dt>{this.props.request.payment.base_fare_text}</dt>
                            ...
                            {this.props.request.payment.distance ? (
                                <span>
                                    <dt>{this.props.request.payment.distance_fare_text}</dt>
                                    <dd>
                                    { this.props.request.currency }{ (this.props.request.payment.distance).toFixed( 2 ) }
                                    </dd>
                                </span>
                            ) : ( "" )}
                             {this.props.request.payment.minute ? (
                                <span>
                                    <dt>{this.props.request.payment.time_fare_text}</dt>
                                    <dd>{this.props.request.currency}{ (this.props.request.payment.minute).toFixed( 2 ) }</dd>
                                </span>
                            ) : ( "" )}
                            ...
                            {this.props.request.payment.tax ? (
                             ...
                             {this.props.request.payment.waiting_amount ? (
                                <span>
                                    <dt>{this.props.request.payment.waiting_fare_text}</dt>
                                    <dd>{this.props.request.currency}{ (this.props.request.payment.waiting_amount).toFixed( 2 ) }</dd>
                                </span>
                            ) : ( "" )}
                        ...
                        {this.props.request.payment_mode != "CASH" ? this.props.request.paid != 1 ? 
                        ( <a id="confirm-invoice" onClick={this.handlePayment} className="btn btn-secondary btn-block" > Pay Now <i className="fa fa-check" aria-hidden="true" /> </a> ) : ( <a data-toggle="modal" data-target="#rating" className="btn btn-secondary btn-block" > Rate Now <i className="fa fa-check" aria-hidden="true" /> </a> ) : ''}
                    </form>
                </div>
                <div>
                                    ...
                                    <div className="trip-user w-100 dis-column">
                                        ...
                                        <div className="rating-outer">
                                             <fieldset className="rating">
                                                <input type="radio" defaultChecked="checked" id="star5" name="rating" value="5" /><label className = "full" htmlFor="star5" ></label>
