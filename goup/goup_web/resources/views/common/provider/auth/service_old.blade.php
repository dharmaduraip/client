         ...
         <div class="col-xs-12 col-sm-12 col-md-12 col-xl-10 wrapper">
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 tranport">
               ...
               <div class="col-md-12 col-sm-12 pro-form vechile-form d-none">
                <div class="vehicle_form_container">
                  <h5 class="word-breakwrap"><strong>@lang('provider.add_vehicle')</strong></h5>
                  <div class="col-md-12 col-sm-12 pro-form  p-0">
                    <div class="row">
                  ...
                  <div class="col-md-12 pro-form  chair p-0 d-none">
                    <div class="row">
                     <div class="col-md-12 col-sm-12 col-xl-6">
                  ...
                  <div class="col-md-12 pro-form  p-0 mt-2">
                  ...
                  <br>
                  <button type="submit" class="btn btn-primary edit-profile mt-3 ml-3">@lang('provider.save') <i class="fa fa-check"
            ...
            <div class="col-md-12 col-lg-12 col-sm-12 p-0 orders d-none">
               ...
               <div class=" row m-0 orders_append">
                ...
                <div class="col-md-12 pro-form dis-ver-center p-0 mt-2">
                    ...
                    <h6><strong>@lang('provider.upload_image')</strong></h6>
                    <p>@lang('provider.upload_insurance')</p>
                    <div class="row p-0 document-upload">
            ...
            <br>
            <button type="submit" class="btn btn-primary  col-md-12 col-lg-3 col-sm-3">@lang('provider.save') <i class="fa fa-check"
                       aria-hidden="true"></i></button>
...
$('body').on('click', '#myservices', function() {
  ...
  if($('.service-box[data-value="'+ $('.category_id').val() +'"]').find('input[name=transport_status]').is(':checked'))
  {
    $('.vehicle_form_container').show();
...
$('body').on('click', '.order_service-box', function() {
    ...
    $('.category_id').val(active_id);
     if($('.order_service-box[data-value="'+ $('.category_id').val() +'"]').find('input[name=transport_status]').is(':checked'))
        {
                ...
                if (response.length != 0) {
                    for (var i in response) {
                        ...
                        if (response[i].providerservice) {
                          if (response[i].providerservice.status != "INACTIVE") {
                              checked = 'checked';
                              check_data=1;
                          }
                        }
                        html += `<div class="col-md-4 col-sm-4 col-xl-2 p-0 ">
                              <div class="dis-column service-box service-box` + response[i].id + `" data-value="` + response[i].id + `" id = "myservices">
                                 ...
                                 <input name="transport_status" type="checkbox" ` + checked + ` value="`+check_data+`" autocomplete="off"/>
                                 <span>
                                 <span>OFF</span>
                                 <span>ON</span>
                                 </span>
...
$('.transportForm').validate({
    ...
    submitHandler: function(form, e) {
        ...
        if($('.service-box[data-value="'+ $('.category_id').val() +'"]').find('input[name=transport_status]').is(':checked'))
        {
          data.append('transport_status',1);
        }
        else{
          data.append('transport_status',0);
        }
