               ...
               <form class=" validateForm" >
                  <div class="col-md-12 p-0 ">
                     ...
                     @if(isset($urlparam['at']))
                        ...
                        <input id="mobile" required name="country_code" maxlength="15" placeholder="@lang('auth.phone_number')"  type="hidden" value="{{$urlparam['country_code']}}" >
                        <input id="mobile" required name="username" maxlength="15" placeholder="@lang('auth.phone_number')"  type="hidden" value="{{$urlparam['mobile']}}" >
                        @else
                        <input id="email" name="username" class="form-control mb-4" placeholder="@lang('auth.email_address')" type="hidden" aria-required="true" required  value="{{$urlparam['email']}}" >
                        @endif
                     @endif
