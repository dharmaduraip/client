...
@section('title') {{ __('Geofence') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('Geofence') }}</span>
            <h3 class="page-title">{{ __('Geofence') }} {{ __('List') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{ __('Geofence') }}</h6>

                    <a href="{{ url('admin/geo-fencing/create') }}" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> {{ __('Add New') }} {{ __('Geofence') }}</a>
                ...
                <thead>
                    <tr>
                            ...
                            <th data-value="location_name">@lang('admin.geo_fencing.location')</th>
                            <th data-value="city_name">@lang('admin.city.city')</th>
            ...
            { "data": function (data, type, row) {
                ...
                if(data.status ==1){
                    ...
                    var button='<div class="input-group-btn action_group"> <li class="action_icon"> <button type="button"class="btn btn-info btn-block "data-toggle="dropdown"><i class="fa fa-ellipsis-v" aria-hidden="true" title="View"></i></button>'+
                           ...
                           button +='<li><a href="{{ url('admin/geo-fencing') }}/'+data.id+'/edit" class="dropdown-item edit"><i class="fa fa-edit"></i> Edit</a> </li>';
                           button +='<li><a href="javascript:;" data-id="'+data.id+'" class="dropdown-item delete"><i class="fa fa-trash"></i> Delete</a> </li>';
                            button +='</ul> </li></div>';
                         return  button;
         ...
         $(".status-modal").modal("show");
            $(".status-modal-btn")
                ...
                .on("click", function() {
                    ...
                    var url = getBaseUrl() + "/admin/geofence/"+id+'/updateStatus?status='+value;
