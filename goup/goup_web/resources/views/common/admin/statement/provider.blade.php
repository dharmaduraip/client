            ...
            <div class="card card-small">
                ...
                <thead>
                    <tr>
                        ...
                        <td id="ridesCount">@lang('admin.provides.Total_Rides')</td>
                        <td id="servicesCount">@lang('admin.provides.Total_Services')</td>
                        <td id="ordersCount">@lang('admin.provides.Total_Orders')</td>
                        <td id="deliveriesCount">@lang('admin.provides.Total_delivery')</td>
...
$(document).ready(function() {
    ...
    var keys = {full_name: "Provider Name", mobile: "Mobile", status: "Status", rides_count: "Total Rides", services_count: "Total Services", delivery_count: " Total Delivery", orders_count: "Total Orders",  payment: "Total Earning", joined: "Joined at"};
    ...
    table = table.DataTable( {
        ...
        "columnDefs": [
            ...
            },
            {
                'targets': [6],
                'render': function (data, type, row, meta){
                    if(row.delivery_count != undefined){
