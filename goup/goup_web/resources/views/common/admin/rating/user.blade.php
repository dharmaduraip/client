...
@section('title') {{ __('User') }} {{ __('Reviews') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('User') }} {{ __('Reviews') }}</span>
            <h3 class="page-title">{{ __('User') }} {{ __('Reviews') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">{{ __('User') }} {{ __('Reviews') }}</h6>
                </div>
                ...
                <thead>
                    <tr>
                            ...
                            <th data-value="request_id">@lang('admin.review.transaction_id')</th>
                            <th data-value="admin_service">@lang('admin.review.admin_service')</th>
                            <th data-value="user_id">@lang('admin.request.User_Name')</th>
                            <th data-value="provider_id">@lang('admin.request.Provider_Name')</th>
                            <th data-value="user_rating">@lang('admin.review.Rating')</th>
                            <th data-value="user_comment">@lang('admin.review.user_comments')</th>
...
$(document).ready(function() { 
    ...
    $('body').on('click', '.view', function(e) {
        ...
        }else if($(this).data('service')=="DELIVERY"){
    ...
    table = table.DataTable( {
        ...
        "serverSide": true,
        "ajax": {
            "url": getBaseUrl() + "/admin/userreview",
            "type": "GET",
        ...
        "columns": [
            ...
            { "data": "user_comment", render: function (data, type, row) {
                    return row.user_comment ? row.user_comment:" No Comments By User";
               }
            },
