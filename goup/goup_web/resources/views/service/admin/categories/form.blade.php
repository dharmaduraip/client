            ...
            <form class="validateForm" files="true">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="service_category_name">{{ __('service.admin.categories.name') }}(English)</label>
                        <input type="text" class="form-control" id="service_category_name" name="service_category_name_en" placeholder="{{ __('service.admin.categories.name') }}" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="service_category_name">{{ __('service.admin.categories.name') }}(Arabic)</label>
                        <input type="text" class="form-control" id="service_category_name_ar" name="service_category_name_ar" placeholder="{{ __('service.admin.categories.name') }}" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="service_category_name">{{ __('service.admin.categories.name') }}(franch)</label>
                        <input type="text" class="form-control" id="service_category_name_fr" name="service_category_name_fr" placeholder="{{ __('service.admin.categories.name') }}" value="">
                    </div>
                </div>
                 <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="service_category_name">{{ __('service.admin.categories.name') }}(spanish)</label>
                        <input type="text" class="form-control" id="service_category_name_es" name="service_category_name_es" placeholder="{{ __('service.admin.categories.name') }}" value="">
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="service_category_alias_name">{{ __('service.admin.categories.alias') }}</label>
                        <input type="text" class="form-control" id="alias_name" name="service_category_alias_name" placeholder="{{ __('service.admin.categories.alias') }}" value="">
                    </div>
                </div>
                <!-- <div class="form-row">
                    <div class="form-group col-md-6">
...
$(document).ready(function()
{
    ...
    $('.validateForm').validate({
		...
		rules: {
            ...
            service_category_alias_name: { required: true },
		...
		messages: {
            ...
            service_category_name: { required: "Category Name is required." },
            service_category_alias_name: { required: "Category Alias Name is required." },
