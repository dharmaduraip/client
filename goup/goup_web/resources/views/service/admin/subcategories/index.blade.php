        ...
        "columns": [
           ...
           /* { "data": "picture", render: function (data, type, row) {
            ...
            { "data": "service_subcategory_status" ,render: function (data, type, row) {
                if(data == 1){
                        return "<label class='switch'><input type='checkbox' class='status_enable switch-warning' checked data-id='"+row.id+"' data-value='"+row.service_subcategory_status+"'> <span class='slider round'></span></label>"

                   }else{
                    return "<label class='switch'><input type='checkbox' class='status_enable'  data-id='"+row.id+"' data-value='"+row.service_subcategory_status+"'> <span class='slider round'></span></label>"
                   }
            }
            },
