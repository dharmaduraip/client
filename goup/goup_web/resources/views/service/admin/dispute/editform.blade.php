...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card-header border-bottom">
            ...
            <h6 class="m-0">{{ __('admin.dispute.update_service_dispute') }}</h6>
        </div>
        <div class="form_pad">
            <form class="validateForm">
				...
				<div class="form-row">
					...
					<input class="form-control" type="text" readonly value="" id="editstatus" name="status">
					</div>
				</div>
            ...
            success: function(data) {
				...
				$("#dispute_type").val(data.responseData.dispute_type.charAt(0).toUpperCase()+data.responseData.dispute_type.slice(1));
				 ...
				 $("#tbody").empty().append(`<tr>
		                   			...
		                   			<td>`+data.responseData.service.service_name+`</td>
		                   		     </tr>`);
