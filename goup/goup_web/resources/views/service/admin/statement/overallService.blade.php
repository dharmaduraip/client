...
@section('title') {{ __('Overall Service Statements') }} @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('Overall Service Statements') }}</span>
            <h3 class="page-title">{{ __('Overall Service Statements') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0">{{ __('Overall Service Statements') }}</h6>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-12">         		
					<form class="form-horizontal" action="{{route('admin.service.statement.range')}}" method="GET" enctype="multipart/form-data" role="form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 mt-10">
                                ...
                                <div class="col-xs-8 text-center">
                                    <a href="{{route('admin.service.statement.range')}}" class="btn btn-primary">{{ __('Reset') }}</a>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="card dashboard_card">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <p class="card-category stats-small__label text-uppercase">{{ __('Total No. of Services') }}</p>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4">
                        <div class="card dashboard_card">
                            <div class="card-header card-header-warning card-header-icon">
                                ...
                                <p class="card-category stats-small__label text-uppercase">{{ __('Cancelled Services') }}</p>
...
$(document).ready(function() {
    ...
    var url = getBaseUrl() + "/admin/service/requestStatementhistory";
        ...
        if ( this.context.length ) {
            ...
            var jsonResult = $.ajax({
                ...
                success: function (result) {
                    $.each(result.responseData.services.data, function (i, data)
                    {   
    ...
    table = table.DataTable( {
        ...
        "ordering": false,
        "ajax": {
            "url": getBaseUrl() + "/admin/service/requestStatementhistory?country_id="+countryVal+"&type="+typeVal+"&from="+FromDate+"&to="+ToDate+'&fleet_id='+fleet_id+'&status='+status+'&provider_id='+provider_id+'&user_id='+user_id+'&ride_type='+ride_type,
            "type": "GET",
            'beforeSend': function (request) {
                showLoader();
            },
            ...
            success: (data, textStatus, jqXHR) => {
               ...
               for (var i in ride_types) {
                    if(ride_type == ride_types[i].id){
                        $('select[name=ride_type]').append(`<option  selected value="` + ride_types[i].id + `">` + ride_types[i].service_category_name + `</option>`);
                    }else{
                        $('select[name=ride_type]').append(`<option value="` + ride_types[i].id + `">` + ride_types[i].service_category_name + `</option>`);
                    }
               }
            },
            error: (jqXHR, textStatus, errorThrown) => {
