            ...
            <div class="card card-small">
                ...
                <div class="col-md-12">
					<form class="validateForm">
						...
						<div class="form-row">
							<div class="form-group col-md-12">
								<label for="password">@lang('admin.account.new_password')</label>
								<input class="form-control" type="password" name="password" id="password" placeholder="New Password">
							</div>
						</div>
						<div class="form-row">
							<div class="form-group col-md-12">
								<label for="password">@lang('admin.account.retype_password')</label>
                		...
                		<button type="submit" class="btn btn-accent float-right">@lang('admin.account.change_password')</button>
						<br><br><br>
					</form>
                </div>  
            </div>
