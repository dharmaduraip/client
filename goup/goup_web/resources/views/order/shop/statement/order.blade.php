...
@section('title') Shop Order Statements @stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">Shop Order Transactions</span>
            <h3 class="page-title">Shop Order Transactions</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0"> Shop Order Transactions</h6>
                </div>
                ...
                <div class="col-lg-12 col-md-12 col-12">         		
					<form class="form-horizontal" action="{{route('shop.statement.range')}}" method="GET" enctype="multipart/form-data" role="form">
...
$(document).ready(function() {
    ...
    table = table.DataTable( {
        ...
        "ordering": true,
        "ajax": {
            "url": getBaseUrl() + "/shop/transactions?transaction_type=order&type="+typeVal+"&from="+FromDate+"&to="+ToDate,
            "type": "GET",
        ...
        "columns": [
            ...
            { "data": "amount_type" },           
            { "data": "amount", render: function (data, type, row) {
                if (typeof row.order.invoice.total_amount !== 'undefined'){
                    return (row.order.currency+''+row.order.invoice.total_amount);
                }
                return 'N/A';
                }
            },
