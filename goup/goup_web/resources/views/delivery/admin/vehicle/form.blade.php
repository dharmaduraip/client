            ...
            <form class="validateForm">
                ...
                <div class="form-row">
                 <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        <label for="vehicle_name">{{ __('admin.vehicle.vehicle_name') }} (English)</label>
                        <input type="text" class="form-control" id="vehicle_name_en" name="vehicle_name_en" placeholder="Vehicle Type Name" value="" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="vehicle_name">{{ __('admin.vehicle.vehicle_name') }} (Arabic)</label>
                        <input type="text" class="form-control" id="vehicle_name_ar" name="vehicle_name_ar" placeholder="Vehicle Type Name" value="" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="vehicle_name">{{ __('admin.vehicle.vehicle_name') }} (Franch)</label>
                        <input type="text" class="form-control" id="vehicle_name_fr" name="vehicle_name_fr" placeholder="Vehicle Type Name" value="" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="vehicle_name">{{ __('admin.vehicle.vehicle_name') }} (Spanish)</label>
                        <input type="text" class="form-control" id="vehicle_name_es" name="vehicle_name_es" placeholder="Vehicle Type Name" value="" autocomplete="off">
                    </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="capacity">{{ __('admin.vehicle.vehicle_capacity_weight') }}</label>
                        <input type="text" class="form-control" id="weight" name="weight" placeholder="Weight" value="" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="capacity">{{ __('admin.vehicle.vehicle_capacity_length') }}</label>
                        <input type="text" class="form-control" id="length" name="length" placeholder="Length" value="" autocomplete="off">
                    </div>
                </div>
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="capacity">{{ __('admin.vehicle.vehicle_capacity_breadth') }}</label>
                        <input type="text" class="form-control" id="breadth" name="breadth" placeholder="Breadth" value="" autocomplete="off">
                    </div>
                    <div class="form-group col-md-6">
                        <label for="capacity">{{ __('admin.vehicle.vehicle_capacity_height') }}</label>
                        <input type="text" class="form-control" id="height" name="height" placeholder="Height" value="" autocomplete="off">
                    </div>
                </div>
