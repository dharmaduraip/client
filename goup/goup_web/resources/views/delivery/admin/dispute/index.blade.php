...
@section('title') {{ __('admin.dispute.delivery_title') }}@stop
...
<div class="main-content-container container-fluid px-4">
    <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
            <span class="text-uppercase page-subtitle">{{ __('admin.dispute.delivery_title') }}</span>
            <h3 class="page-title">{{ __('admin.dispute.delivery_title') }}</h3>
        </div>
    </div>
        ...
        <div class="col-md-12">
            <div class="card card-small">
                <div class="card-header border-bottom">
                    <h6 class="m-0 pull-left">{{ __('admin.dispute.delivery_title') }}</h6>
                    
                    <a href="javascript:;" class="btn btn-success pull-right add"><i class="fa fa-plus"></i> {{ __('admin.dispute.add_delivery_dispute') }}</a>
...
$(document).ready(function() {
    ...
    var url = getBaseUrl() + "/admin/delivery/requestdispute";
    ...
    $('.add').on('click', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/delivery-requestdispute/create') }}", function(data) {
    ...
    $('body').on('click', '.edit', function(e) {
        e.preventDefault();
        $.get("{{ url('admin/delivery-requestdispute/') }}/"+$(this).data('id')+"/edit", function(data) {
            $('.crud-modal .modal-container').html("");
            $('.crud-modal .modal-container').html(data);
        });
        $('.crud-modal').modal('show');
   ...
   var currency_symbol="$"
    ...
    table = table.DataTable( {
        ...
        "ajax": {
            "url": getBaseUrl() +"/admin/delivery/requestdispute",
            "type": "GET",
            'beforeSend': function (request) {
                showLoader();
            },
