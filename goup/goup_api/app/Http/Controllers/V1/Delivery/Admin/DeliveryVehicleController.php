...
class DeliveryVehicleController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'vehicle_name_en' => 'required|max:255',            
        ...
        try {
                ...
                $rideDeliveryVehicle->vehicle_name = $request->vehicle_name_en;
                $rideDeliveryVehicle->vehicle_name_en = $request->vehicle_name_en;            

                $rideDeliveryVehicle->vehicle_name_fr = $request->vehicle_name_fr;            

                $rideDeliveryVehicle->vehicle_name_ar = $request->vehicle_name_ar;            

                $rideDeliveryVehicle->vehicle_name_es = $request->vehicle_name_es;            
    ...
    public function rideprice(Request $request)
    {
       ...
       /* $this->validate($request, [
         ...
         $this->validate($request, [
            ...
            'distance_price' => 'sometimes|nullable|numeric',
        ...
        try{
                ...
                if(!empty($request->distance_price))
                    $ridePrice->price = $request->distance_price;
                else
                    $ridePrice->price=0;
    ...
    public function getRidePrice($city_id, $ride_delivery_vehicle_id)
    {
       
            $rideCityPrice = DeliveryCityPrice::where([['company_id',Auth::user()->company_id],
                                         ['delivery_vehicle_id',$ride_delivery_vehicle_id],
                                         ['city_id',$city_id]])
                                        // ->where('pricing_differs', 0)
                                        ->first();
    ...
    public function getcity(Request $request)
    {
        ...
        $menudetails=Menu::select('menu_type_id')->where('id',$request->menu_id)->first();
         ...
         $rideprice=DeliveryCityPrice::select('city_id')->whereHas('ridedelivery_type', function($query) use($menudetails){
