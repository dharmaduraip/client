...
class DeliveryTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'delivery_name_en' => 'required|max:255',
        ...
        try {
                ...
                $DeliveryType->delivery_name = $request->delivery_name_en; 
                $DeliveryType->delivery_name_ar = $request->delivery_name_ar;
                $DeliveryType->delivery_name_fr = $request->delivery_name_fr;
                $DeliveryType->delivery_name_es = $request->delivery_name_es;
                $DeliveryType->delivery_name_en = $request->delivery_name_en;  
                $DeliveryType->delivery_category_id = $request->delivery_category_id;         
                $DeliveryType->status = 1;
                $DeliveryType->save();
