...
class VehicleTypeController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
                ...
                $RideType->ride_name_es = $request->ride_name_es;
                $RideType->ride_name_fr = $request->ride_name_fr;               
                $RideType->ride_name = $request->ride_name_en; 
                $RideType->ride_name_en = $request->ride_name_en; 
                $RideType->ride_name_ar = $request->ride_name_ar;            
                $RideType->status = 0;
                $RideType->save();
