...
class ServiceCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            ...
            'service_category_name_en' => 'required|unique:service.service_categories,service_category_name|max:255|regex:/^[a-zA-Z0-9\s]+$/',
        ...
        try {
            ...
            $ServiceCategory->service_category_name = $request->service_category_name_en;
            $ServiceCategory->service_category_name_en = $request->service_category_name_en;
            $ServiceCategory->service_category_name_ar = $request->service_category_name_ar;
            $ServiceCategory->service_category_name_fr = $request->service_category_name_fr;

            $ServiceCategory->service_category_name_es = $request->service_category_name_es;
    ...
    {
        $this->validate($request, [
            'service_category_name_en' => 'required|max:255|regex:/^[a-zA-Z0-9\s]+$/',
            'service_category_alias_name' => 'required|max:255|regex:/^[a-zA-Z0-9\s]+$/',
            /*'picture' => 'mimes:jpeg,jpg,bmp,png|max:5242880',
            'service_category_order' => 'required|integer|between:0,10',*/
            'service_category_status' => 'required',
