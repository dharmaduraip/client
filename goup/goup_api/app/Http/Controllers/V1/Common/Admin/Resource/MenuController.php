...
class MenuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $datum = Menu::with('adminservice')->whereHas('service' ,function($query){  
    ...
    public function store(Request $request) 
    {
        ...
        try{
           ...
           if($request->admin_service == 'TRANSPORT'){
            $vehicle_type_list = RideType::find($request->menu_type_id);
            $menu->title_en = $vehicle_type_list->ride_name_en;      

            $menu->title_fr = $vehicle_type_list->ride_name_fr;     
            $menu->title_ar = $vehicle_type_list->ride_name_ar;
            $menu->title_es = $vehicle_type_list->ride_name_es;

            }elseif($request->admin_service == 'SERVICE'){
            $vehicle_type_list = ServiceCategory::find($request->menu_type_id);
            $menu->title_en = $vehicle_type_list->service_category_name_en;      
            $menu->title_fr = $vehicle_type_list->service_category_name_fr;     
            $menu->title_ar = $vehicle_type_list->service_category_name_ar;
            $menu->title_es = $vehicle_type_list->service_category_name_es;
            }elseif($request->admin_service == 'ORDER'){
            $vehicle_type_list = StoreType::find($request->menu_type_id);
            $menu->title_en = $vehicle_type_list->name_en;      
            $menu->title_fr = $vehicle_type_list->name_fr;     
            $menu->title_ar = $vehicle_type_list->name_ar;
            $menu->title_es = $vehicle_type_list->name_es;
            }                          
    ...
    public function service_type()
    {
     ...
     public function delivery_type()
     {
        \Log::info('data set');
         ...
         $service_list = DeliveryCategory::where('company_id', Auth::user()->company_id)->get();
         return Helper::getResponse(['data' => $service_list]);
     }
