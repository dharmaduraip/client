...
class RideRequest extends BaseModel
{
    ...
    protected $appends = ['created_time','assigned_time', 'schedule_time', 'started_time', 'finished_time','total_distance'];
    ...
    {
        return $this->hasOne('App\Models\Common\Rating', 'request_id')->where('admin_service','TRANSPORT');
    }
    ...
    {
        return $this->belongsTo('App\Models\Common\ProviderService', 'provider_service_id');
    }
