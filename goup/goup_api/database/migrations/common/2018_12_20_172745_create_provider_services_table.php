...
class CreateProviderServicesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('provider_services', function (Blueprint $table) {
            ...
            $table->unsignedInteger('category_id')->nullable()->comments('It represents ride type, category or shop type for corresponding transport, service, and order respectively.');
            ...
            $table->enum('status', ['ASSESSING','ACTIVE','INACTIVE','RIDING','SERVICE','ORDER']);
