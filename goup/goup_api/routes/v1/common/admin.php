...
$router->group(['middleware' => 'auth:admin'], function ($app) {
    ...
    $app->post('/dispatcher/order/request', 'V1\Common\Admin\Resource\DispatcherController@create_order');

    $app->post('/dispatcher/service/cancel', 'V1\Common\Admin\Resource\DispatcherController@cancel_service');

    $app->post('/dispatcher/delivery/request', 'V1\Common\Admin\Resource\DispatcherController@create_delivery');
    ...
    $app->delete('/provider/delete_address_pfofile/{id}', 'V1\Common\Admin\Resource\ProviderController@delete_address_pfofile');
    //CompanyCountry
