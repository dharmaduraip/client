...
class Kernel extends HttpKernel
{
	...
	'candi_roleapi' => \App\Http\Middleware\Candidateroleapi::class,
		'user_activeapi' => \App\Http\Middleware\Useractiveapi::class,
        'employer_roleapi' => \App\Http\Middleware\Employerroleapi::class,
            ];
}
