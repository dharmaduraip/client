...
class Company extends Model
{
    ...
    protected $appends = ['logo_url', 'banner_url', 'full_address','founded_date'];
    ...
    public function getFullAddressAttribute()
    {
    	...
    	public function getFoundedDateAttribute()
    {
        $date = date('j F, Y', strtotime($this->establishment_date)) ;
    ...
    public function filter_application($query = '')
    {
		 if(empty($query)){
			return $this->applicationGroups();
		} else {
			return $this->applicationGroups()->where('name','like','%'.$query.'%');
		}	
