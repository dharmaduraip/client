...
@section('main')
    ...
    class="form-control phonecode " value="@isset($contact->phone){{$contact->phone}}@endisset" pattern="[0-9]{10,16}" placeholder="Phone" title="0123456789">
    ...
    class="form-control phonecode " value="@if(isset($contact->secondary_phone)){{$contact->secondary_phone}}@endisset" pattern="[0-9]{10,16}" placeholder="Phone" title="0123456789">
    ...
    class="form-control phonecode " value="@isset($contact->email)  {{ $contact->email}} @endisset" placeholder="{{ __('email_address') }}">
