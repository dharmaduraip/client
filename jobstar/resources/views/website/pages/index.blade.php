...
@section('main')
                        ...
                        <div class="banner-content5">
                            ...
                            @if ($top_categories->count())
                                <div class="f-size-14 banner-quciks-links " data-aos="" data-aos-duration="1000"
                                    data-aos-delay="500">
                                    <span class="text-gray-4001 d-block mb-3">{{ __('suggestion') }}: </span>
                                    <div class="d-flex flex-wrap">
                                    @foreach ($top_categories as $item)
                                        <a class="mb-2 me-1" href="{{ route('website.job', ['category' => $item->id]) }}">
                                            {{ $item->name }} 
                                        </a>
                                    @endforeach
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    <div class="f-size-24 ft-wt-5"><span class="counter">{{ livejob() }}</span>
                                    </div>
                                    <span class="text-black-500 f-size-16">{{ __('live_job') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-black-500 f-size-16">{{ __('companies') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-black-500 f-size-16">{{ __('candidates') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="rt-single-icon-box">
                                ...
                                <div class="iconbox-content">
                                    ...
                                    <span class="text-black-500 f-size-16">{{ __('new_jobs') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="most-popular-wrap">
                            <div class="most-popular-item">
                                ...
                                <div class="most-popular-data">
                                    <h3>
                                        <a
                                        href="{{ route('website.job', ['job_role' => $role->id]) }}">{{ $role->name }}</a>
                                     </h3>
            ...
            <div class="row">
                @foreach ($popular_categories as $category)
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <a href="{{ route('website.job', ['category' => $category->id]) }}">
                            <div class="popular-category-item">
                                ...
                                <div class="popular-category-data">
                                    <h4>{{ $category->name }}</h4>
                                    <p>{{ $category->open_position_count }} {{ __('open_position') }}</p>
                                </div>
                            </div>
                        </a>
                    </div>
    ...
    <div class="working-process tw-bg-[#F1F2F4]">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 wow fadeInUp animated" style="visibility: visible; animation-delay: 0ms; animation-name: fadeInUp;">
                    <div class="single-coaching-item text-center px-2">
                        <div class="icon">
    ...
    @if ($top_companies->count() > 0)
        @if (!auth('user')->check() || (auth('user')->check() && auth('user')->user()->role == 'candidate'))
                        ...
                        @foreach ($top_companies as $company)
                            <div class="col-xl-4 col-md-6 fade-in-bottom  condition_class rt-mb-24">
                                <div class="card jobcardStyle1">
                                    <div class="card-body">
                                        <div class="rt-single-icon-box tw-mb-6">
                                            <div class="icon-thumb company-logo">
                                                <img src="{{ $company->logo_url }}" alt="" draggable="false">
                                            </div>
                                            <div class="iconbox-content">
                                                <div class="">
                                                     @isset($company->user->name)
                                                     @isset($company->user->username)
                                        ...
                                        <div class="post-info d-flex">
                                            <div class="flex-grow-1">
                                                @if ($company->jobs_count == 0)
                                                    <div type="button"
                                                        class="d-block text-dark border-0 text-center">
