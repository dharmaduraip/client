                        ...
                        <div class="tempsec">
                            @if($section == "header")
                                <div style="padding:15px;">
                                    ...
                                    <p class="center">{{ $user->email }} @if($user->mobile_num != "" || $user->mobile_num != NULL)| {{ $user->mobile_num }} @endif @if($user->city != "" || $user->city != NULL) | {{ $user->city }}, @endif{{ $user->country }} {{ $user->pin_code }}</p>
                                </div>
