                        ...
                        <div class="auth-box2">
                            <form id="formId" action="{{ route('register') }}" method="POST" class="rt-form">
                                        ...
                                        <div class="tw-bg-[#F1F2F4] tw-rounded-lg tw-mb-6 tw-p-3">
                                            ...
                                            <div
                                                ...
                                                <input id="switcher-toggle-on"
                                                    ...
                                                    value="candidate" type="radio" <?php if($role == 'candidate'): ?> checked=""<?php endif; ?>>
                                                ...
                                                <input id="switcher-toggle-off"
                                                    ...
                                                    value="company" type="radio" <?php if($role == 'company'): ?> checked=""<?php endif; ?>>
                                                    @else
                                                    <input id="switcher-toggle-off"
                                                    class="switcher-toggle switcher-toggle-right tw-w-full" name="role"
                                                    value="company" type="radio"  checked="">
                                                    @endif
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="fromGroup rt-mb-15">
                                            <input name="name" id="name" value="{{ old('name') }}"
                                                class="field form-control @error('name') is-invalid @enderror" pattern="[a-zA-Z ]{3,40}"     oninput="this.value = this.value.replace(/[^a-zA-Z , ]/, '')"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="fromGroup rt-mb-15">
                                            <input name="username" id="name" value=""
                                                class="field form-control @error('username') is-invalid @enderror" pattern="[a-zA-Z ]{3,40}"     oninput="this.value = this.value.replace(/[^a-zA-Z , ]/, '')"
                                    ...
                                    <div class="col-12">
                                        <div class="fromGroup rt-mb-15">
                                            <input type="email" id="email" value="{{ old('email') }}" name="email"  pattern="[a-zA-Z0-9]{3,255}@[a-zA-Z]{3,10}[.]{1}[a-zA-Z]{2,6}"
                                                class="field form-control @error('email') is-invalid @enderror"
                                                placeholder="{{ __('email_address') }}" title="example@gmail.com">
                                            @error('email')
                                                <span class="invalid-feedback" role="alert">{{ __($message) }}</span>
                                            @enderror
                                        </div>
