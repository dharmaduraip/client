<aside id="sidebar" class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        <div class="sidebar-nav-wrapper">
            <!-- Sidebar Menu -->
            <nav class="sidebar-main-nav mt-2" id="style-3">
                <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <x-admin.sidebar-dropdown :linkActive="Request::is('admin/industryType*') || Request::is('admin/profession*') || Request::is('skill.*') || Request::routeIs('tags.*') || request()->routeIs('benefit.*') ||  request()->routeIs('admin.candidate.language.*') || Request::is('admin/skill*')
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                @if (userCan('tags.view'))
                                    <x-admin.sidebar-list :linkActive="request()->routeIs('tags.*') ? true : false" route="tags.index"
                                        icon="fas fa-tags">
                                        {{ __('tags') }}
                                    </x-admin.sidebar-list>
                                @endif
                    ...
                    <!--=========== Resume Templates ========= -->
                    @if (userCan('admin.view'))
                        <x-admin.sidebar-list :linkActive="Route::is('resume.*') ? true : false" route="resume.templates" parameter="" icon="fas fa-users">
                            {{ __('Resume Templates') }}
                        </x-admin.sidebar-list>
                    @endif
                </ul>
