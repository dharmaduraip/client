...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('backend/css/vendor.min.css') }}">
    <style>
        .system-logo {
...
/*            background-image: url('https://source.unsplash.com/random/1920x1280');*/
              background-image: url('https://cdni.iconscout.com/illustration/premium/thumb/login-page-4468581-3783954.png');
    ...
    <div class="container-fluid" style="height:100vh;">
        <div class="row justify-content-center" style="height:100%;">
            <div class="col-lg-4 col-md-5">
                <div class="d-flex flex-column justify-content-center align-items-center py-5 px-4 min-vh-100">
