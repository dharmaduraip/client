                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('company.show', $order->company->id) }}" class="company">
                                                <img src="{{ $order->company->logo_url }}" alt="">
                                                <div>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                ...
                                                <div>
                                                    <a onclick="return confirm('{{ __('are_you_sure') }}')" href="{{ route('manual.payment.mark.paid', $order->id) }}">
                                                        {{ __('mark_as_paid') }}
                                                    </a>
                                                </div>
                                            @endif
                                        ...
                                        <td class="d-flex">
                                            <a href="{{ route('order.show', $order->id) }}" class="btn ll-btn">
                                                {{ __('view_details') }}
