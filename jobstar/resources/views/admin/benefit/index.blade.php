                            ...
                            <div class="pt-3 pb-4">
                                <form class="form-horizontal" action="{{ route('benefit.update', $benefit->id) }}"
                                    ...
                                    @foreach ($app_language as $key => $language)
                                        ...
                                        //    $value = $code == $language->code ? $benefit->translations[$key]['name']: '';
                                         if(isset($benefit->translations[$language->code])){
$code = $benefit->translations[$language->code]['locale'];
$value = $benefit->translations[$language->code]['name'];
} else {
	$code = '';
	$value = '';
}
