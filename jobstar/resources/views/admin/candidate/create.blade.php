                            ...
                            <div class="card-body row">
                                <div class="col-md-12">
                                    <div class="form-group name_div">
                                        ...
                                        <x-forms.input type="text" class="acco_name" name="name" placeholder="name" />
										<span class=" text-bold text-danger hide"> Please Enter Alphabate </span>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-group pass_div">
                                            ...
                                            <x-forms.input class="form_pwd" type="password" name="password" placeholder="password" />
											<i class="nav-icon fas fa-eye custom_icon" id="eye"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div id="google-map-div" class="{{ $map == 'google-map' ? '' : 'd-none' }}">
                                    <input id="searchInput" name="location" class="mapClass" type="text" placeholder="Enter a location">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input name="image" type="file" data-show-errors="true" data-width="100%"
                                            data-default-file="" class="dropify" accept="image/png, image/jpeg, image/gif, image/jpg, image/svg">
                                        @error('image')
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-file">
                                                <input name="cv" type="file"
                                                    class="custom-file-input @error('cv') is-invalid @enderror" accept=".pdf, .doc, .docx">
...
@section('script')
	...
	$(document).ready(function(){
	   ...
	   $('.pass_div .custom_icon').on('click', function(){
		    $(this).toggleClass("fa-eye fa-eye-slash");
		  var passInput=$(".pass_div .form_pwd"); // fa-eye-slash
	...
	$('.name_div .acco_name').keypress(function (e) {
