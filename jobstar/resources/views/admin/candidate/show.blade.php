                                    ...
                                    <div class="d-flex align-items-center" style="gap: 16px;">
                                        <div>
                                            <a href="javascript:void(0)" class="active-status">
                                                ...
                                                <p class="{{ $user->status == 1 ? 'active' : '' }}" id="status_{{ $candidate->user_id }}">
                                        ...
                                        <div>
                                            <a href="javascript:void(0)" class="active-status">
                                                ...
                                                <p class="{{ $user->email_verified_at ? 'active' : '' }}" id="verification_status_{{ $candidate->user_id }}">
                            ...
                            <div class="candidate-details__right">
                                <div class="one">
                                    <div class="mb-4">
                                        ...
                                        <p>{{ __('profession') }}</p>
                                        {{--<h4>{{ isset($candidate->title) ? $candidate->title : '' }}</h4>--}}
                                        <h4>{{ isset($candidate->profession) ? $candidate->profession->name : '' }}</h4>
                                    </div>
                                    <div>
                                ...
                                <div class="four">
                                    ...
                                    <div class="mb-4 d-flex">
                                        ...
                                        <div>
                                            <p>{{ __('phone') }}</p>
                                            <a href="tel: {{ $user->contactInfo->phone }}">{{ $user->contactInfo->phone }}</a>
                                        </div>
                                    </div>
                                    @endif
