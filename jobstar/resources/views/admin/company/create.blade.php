                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group" style="position: relative;">
                                ...
                                <i class="far fa-eye" id="togglePassword" style="margin-left: -30px; cursor: pointer; position: absolute;right: 13px;top: 41px;"></i>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        ...
        function passToText(id, icon) {
            const c = document.querySelector('#password');
            const icon_sym = document.querySelector('#togglePassword');
            const type = password.getAttribute('type') === 'password' ? 'text' : 'password';
            password.setAttribute('type', type);
            const symbol = password.getAttribute('type') == 'password' ? 'far fa-eye' : 'far fa-eye-slash';
            icon_sym.setAttribute('class', symbol);
        }
