...
Route::middleware('auth:user', 'verified')->group(function () {
    ...
    Route::controller(CandidateController::class)->prefix('candidate')->middleware('candidate')->name('candidate.')->group(function () {
        ...
        Route::get('build-resume', 'buildResume')->name('build.resume');
        Route::post('template', 'candidateTemplate')->name('template');
        Route::get('build-resume/header', 'sectionHeader')->name('section.header');
        Route::get('preview/header', 'previewHeader')->name('preview.header');
        Route::post('build-resume/header', 'headerPost')->name('header.post');
        Route::get('build-resume/experience', 'sectionExperience')->name('section.experience');
        Route::get('build-resume/add-experience', 'addExperience')->name('add.experience');
        Route::post('build-resume/experience', 'experiencePost')->name('experience.post');
        Route::get('Fresher','noExperience')->name('fresher');
        Route::get('preview/experience', 'previewExperience')->name('preview.experience');
        Route::get('edit-experience/{id}', 'editExperience')->name('edit.experience');
        Route::post('update/experience', 'experienceUpdate')->name('experience.update');
        Route::get('delete-experience/{id}', 'deleteExperience')->name('delete.experience');
        Route::get('build-resume/education', 'sectionEducation')->name('section.education');
        Route::post('build-resume/education', 'educationPost')->name('education.post');
        Route::get('build-resume/add-education', 'addEducation')->name('add.education');
        Route::get('edit-education/{id}', 'editEducation')->name('edit.education');
        Route::post('build-resume/update-education', 'updateEducation')->name('update.education');
        Route::get('delete-education/{id}', 'deleteEducation')->name('delete.education');
        Route::get('preview/education', 'previewEducation')->name('preview.education');
        Route::get('build-resume/skills', 'sectionSkills')->name('section.skills');
        Route::get('build-resume/add-skill', 'addSkill')->name('add.skill');
        Route::post('build-resume/add-skill', 'skillsPost')->name('skills.post');
        Route::get('preview/skills', 'previewSkills')->name('preview.skills');
        Route::get('build-resume/summary', 'sectionSummary')->name('section.summary');
        Route::get('build-resume/add-summary', 'addSummary')->name('add.summary');
        Route::get('build-resume/edit-summary', 'editSummary')->name('edit.summary');
        Route::post('build-resume/add-summary', 'summaryPost')->name('summary.post');
        Route::get('build-resume/add-languages', 'addLanguages')->name('add.languages');
        Route::post('build-resume/add-languages', 'languagesPost')->name('languages.post');
        Route::get('build-resume/finalize', 'sectionFinalize')->name('section.finalize');
        Route::get('resume/download', 'downloadResume')->name('resume.download');
    ...
    Route::controller(CompanyController::class)->prefix('company')->middleware(['company', 'has_plan'])->name('company.')->group(function () {
        Route::middleware('company.profile')->group(function () {
            ...
            Route::get('message', 'message')->name('message')->withoutMiddleware('has_plan');
