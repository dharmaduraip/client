...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    <a href="{{url('googlemeet/dashboard')}}" class="btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>{{ __("Back")}}</a>
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="form-group col-md-12"  id="sec3_three">
