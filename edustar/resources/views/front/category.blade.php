    ...
    <div class="container-xl">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <a href="{{ route('subcategory.page',['id' => $cat->id, 'category' => str_slug(str_replace('-','&',$cat->slug))]) }}">
...
<section id="categories" class="categories-main-block categories-main-block-one">
    <div class="container-xl">
        ...
        <div class="row">
            ...
            @if($cat->status == 1)
            <div class="col-lg-3 col-sm-6">
                <a href="{{ route('childcategory.page',['id' => $cat->id, 'category' => str_slug(str_replace('-','&',$cat->slug))]) }}">
                    <div class="categories-block">
                        <ul>
                            <li>
                                <span title="{{ $cat->title }}">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 ">
                ...
                <div class="text-right">
                    {{ __('Showing result')}} {{ $filter_count }} of {{ $course_count }}
                </div>
                            ...
                            <div class="card-body">
                                <div class="categories-tags">
                                    <div class="categories-content-one">
                                        <div class="categories-tags-content-one">
                                            @php
                                            $CourseLanguage = App\CourseLanguage::where('status','1')->get();
                                            @endphp
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-3 course-bought-block-one">
                                        ...
                                        <div class="view-user-img">
                                            ...
                                            <a href="" title=""><img src="{{ asset('images/user_img/'.$course->user['user_img']) }}" class="img-fluid user-img-one" alt=""></a>
                                            @else
