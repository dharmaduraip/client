                ...
                <div class="view-block">
                    ...
                    <div class="view-user-img">
                        @if($enrol->courses->user['user_img'] !== NULL && $enrol->courses->user['user_img'] !== '')
                            <a href="{{ route('all/profile',$enrol->instructor_id) }}" title=""><img src="{{ asset('images/user_img/'.$enrol->courses->user['user_img']) }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @else
                            <a href="{{ route('all/profile',$enrol->instructor_id) }}" title=""><img src="{{ asset('images/default/user.png') }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @endif
                    </div>
                    <div class="view-dtl">
                        <div class="view-heading"><a
                                href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}">{{ str_limit($enrol->courses->title, $limit = 35, $end = '...') }}</a>
                        </div>
                        <div class="user-name">
                            {{-- <h6>{{ __('By')}} <span><a href="{{ route('all/profile',$enrol->courses->user_id) }}"> {{ optional($enrol->courses->user)['fname'] }}</a></span></h6> --}}
            ...
            <div class="col-lg-3 col-sm-6">
                ...
                <div class="view-block">
                    <div class="view-img">
                        ...
                        <a href="{{ route('course.content',['id' => $coursess->id, 'slug' => $coursess->slug ]) }}"><img
                    ...
                    <div class="view-user-img">
                        @if($coursess->user['user_img'] !== NULL && $coursess->user['user_img'] !== '')
                            <a href="{{ route('all/profile',$coursess->user->id) }}" title=""><img src="{{ asset('images/user_img/'.$coursess->user['user_img']) }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @else
                            <a href="{{ route('all/profile',$coursess->user->id) }}" title=""><img src="{{ asset('images/default/user.png') }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @endif
                    </div>
                    <div class="view-dtl">
                        <div class="view-heading"><a
                                href="{{ route('course.content',['id' => $coursess->id, 'slug' => $coursess->slug ]) }}">{{ str_limit($coursess->title, $limit = 35, $end = '...') }}</a>
                        </div>
                        <div class="user-name">
    ...
    <div class="container-xl">
        <div class="business-dtl">
            <div class="row">
                <div class="col-lg-6">
                    <div class="bredcrumb-dtl">
                        <h1 class="wishlist-home-heading">{{ __('Meetings') }}</h1>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="view-block">
                    ...
                    <div class="view-user-img">
                        @if($meeting->user['user_img'] !== NULL && $meeting->user['user_img'] !== '')
                            <a href="{{ route('all/profile',$meeting->user->id) }}" title=""><img src="{{ asset('images/user_img/'.$meeting->user['user_img']) }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @else
                            <a href="{{ route('all/profile',$meeting->user->id) }}" title=""><img src="{{ asset('images/default/user.png') }}" class="img-fluid user-img-one user-img-two" alt=""></a>
                        @endif
                    </div>
                    <div class="view-dtl">
