          ...
          <div class="view-order">
            <div class="row invoice-info">
              ...
              <div class="col-sm-4 invoice-col">
                ...
                <b>{{ __('Enroll on') }}:</b> {{ date($test, strtotime($orders['created_at'])) }}</br>
                <b>
                  @if($orders->enroll_expire != NULL)
                  {{ __('Enroll End') }}:</b>
                {{ date($test, strtotime($orders['enroll_expire'])) }}</br>
                @endif
              </div>
              <!-- /.col -->
            </div>
                ...
                <tr>
                  <td>
                    ...
                    <div class="purchase-history-course-title">
                      <a
                        href="{{ route('course.content',['id' => $coursess->id, 'slug' => $coursess->slug ]) }}">{{ $coursess->title }}</a>
                    </div>
                  </td>
                </tr>
              </tbody>
