			            	...
			            	<tr>
				    			<td >
				                    <div class="purchase-history-course-img">
				                    	@if($order->course_id != NULL)
					                        ...
					                        @else
					                        	<a href="{{ route('user.course.show',['id' => $order->courses->id, 'slug' => $order->courses->slug ]) }}"><img src="{{ Avatar::create($order->courses->title)->toBase64() }}" class="img-fluid" alt="{{ __('course')}}"></a>
					                        @endif
				                        @else
				                ...
				                <td>
				                    ...
				                    @php
                                    	...
                                    	$days = isset($course->refund_policy_id) ? $ref['days'] : 0 ;
