                                ...
                                @if(Auth::check())
                                    ...
                                    @if(Auth::User()->role == "admin")
                                        <div class="about-home-btn btm-20">
                                            <a href="{{ route('course.content',['id' => $course->id, 'slug' => $course->slug ]) }}" class="btn btn-secondary" title="course">{{ __('Go To Course') }}</a>
                                        </div>
                                    @else
                                        ...
                                        @else
                                            ...
                                            @else
                                                ...
                                                <div class="about-home-btn btm-20">
                                                    <form id="demo-form2" method="post" action="{{ route('buynow') }}"
                                                        data-parsley-validate class="form-horizontal form-label-left">
                                                            {{ csrf_field() }}
                            ...
                            @else
                                ...
                                @if(Auth::check())
                                    ...
                                    @else
                                        ...
                                        @else
                                            <div class="about-home-btn btm-20">
                                                <a href="{{ route('course.content',['id' => $course->id, 'slug' => $course->slug ]) }}" class="btn btn-secondary" title="Cart">{{ __('Go To Course') }}</a>
                                            </div>
                                        @endif
                                    @endif
                                @else
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="about-home-share text-center">
                                        <a href="https://calendar.google.com/calendar/r/eventedit?text={{ $course['title'] }}" target="__blank" title="calendar" ><i data-feather="calendar"></i></a>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="about-home-share text-center">
                ...
                <div class="about-content-sidebar">
                    <div class="container-xl">
                        ...
                        @if($course->user['user_img'] !== NULL && $course->user['user_img'] !== '')
                                <img src="{{ asset('images/user_img/'.$course->user['user_img']) }}" class="img-fluid" alt="">
                            @else
                            <img src="{{ asset('images/default/user.png') }}" class="img-fluid" alt="">
                                @endif
                        ...
                        <div class="about-reward-badges">
                            <img src="{{url('images/badges/1.png')}}" class="img-fluid" alt="" data-toggle="tooltip" data-placement="bottom" title="Member Since {{ $course->user->created_at->diffForHumans() }}">
                            @if($course_count >= 5)
                            ...
                            @endif
                            <img src="{{url('images/badges/3.png')}}" class="img-fluid" alt="" data-toggle="tooltip" data-placement="bottom" title="Here user has applied {{ $enroll_count }} courses">
                            <img src="{{url('images/badges/4.png')}}" class="img-fluid" alt="" data-toggle="tooltip" data-placement="bottom" title="Affiliate Users {{ $affiliate_user }}">
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <a href="{{ route('instructor.profile', ['id' => $course->user->id, 'name' => $fullname] ) }}" class="btn btn-primary" title="course">{{ __('Profile')}}</a>
                            </div>
      ...
      @if(isset($insti))
                        <div class="about-content-img">
                            @if(isset($insti['image'] ) && $insti['image'] !== NULL && $insti['image'] !== '')
                                <img src="{{ asset('files/institute/'.$insti->image) }}" class="img-fluid" alt="">
                            @else
                                <img src="{{ Avatar::create($insti->title)->toBase64() }}" class="img-fluid" alt="">
                            @endif
            ...
            <div class="col-lg-8 col-md-8">
                @if($whatlearns->isNotEmpty())
                    <div class="product-learn-block">
                        <h3 class="product-learn-heading">{{ __('Whatlearn') }}</h3>
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="product-learn-dtl">
                                    <ul>
                                        <li><i data-feather="check-circle"></i>{{ str_limit($wl['detail'], $limit = 200, $end = '...') }}</li>
                                    </ul>
                                </div>
                            </div>
                            @endif
                ...
                <div class="course-content-block btm-30 top-20">
                    ...
                    <div class="row" style="padding-bottom:10px">
                        ...
                        <div class="col-lg-3 col-6 col-xs-6 nopadding">
                            <button type="button" onclick="toggleAllSections()" class="btn btn-link courseToggle"><span style="color:#0384a3">{{ __('Expand all sections') }}</span></button>
                            <button type="button" onclick="toggleAllSections()" class="btn btn-link courseToggle" style="display:none"><span style="color:#0384a3">{{ __('Collapse all sections') }}</span></button>
                        </div>
                    </div>
                    <!-- FSMS -->
               ...
               @php
                    ...
                    <div class="course-bought-block">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-sm-8 col-12">
                                <div class="course-name btm-10"><a href="{{ route('user.course.show',['id' => $item->id, 'slug' => $item->slug ]) }}">{{ str_limit($item['title'], $limit = 35, $end = '...') }}</a></div>
                ...
                <div class="learning-review btm-40">
                    ...
                    @if( !empty($user_enrolled) || Auth::user()->role == 'admin' || count($course_id) > 0 || in_array($course->id, $course_id))
                        ...
                        <div class="row btm-20">
                            ...
                            <div class="col-lg-8">
                                <div class="review-rating">
                                    ...
                                    @php
                                        $help = App\ReviewHelpful::where('user_id', Auth::User()->id)->where('review_id', $rating->id)->first();
                                        $likecount = App\ReviewHelpful::where('review_id', $rating->id)->where('review_like','1')->count();
                                        $dislikecount = App\ReviewHelpful::where('review_id', $rating->id)->where('review_dislike','1')->count();
                                    @endphp
                                    @if($rating->user_id != Auth::User()->id)
                                        <div class="review">{{ __('helpful') }}?
                                            @if(!empty($help) && $help['review_like'] == '1')
                                                <div class="helpful">
                                                    ...
                                                    <button type="submit" class="btn btn-link lft-7 rgt-10 " style="background: green;color:white"><i class="fa fa-check"></i> {{ __('Yes') }}</button>
                                                    </form>
                                                </div>
                                            @else
                                                <div class="helpful">
                                            ...
                                            @if(isset($help) && $help['review_dislike']== '1')
                                                <div class="helpful">
                                                    ...
                                                    <button type="submit" class="btn btn-link lft-7 rgt-10 " style="background: green;color:white"><i class="fa fa-check"></i> {{ __('No') }}</button>
                                                    </form>
                                                </div>
                                            @else
                                                <div class="helpful">
                                    ...
                                    @endif
                                    <p> 👍 helpful({{ $likecount }}) &emsp; &emsp; 👎 not helpful({{ $dislikecount }})</p>
                                    @endauth
                ...
                <div class="more-courses btm-30">
                    <h2 class="more-courses-heading">{{ __('Related Courses') }}</h2>
                    <div class="row">
                                ...
                                <div class="student-view-block">
                                    <div class="view-block">
                                        ...
                                        <div class="view-user-img">
                                            @if($rel->user['user_img'] !== NULL && $rel->user['user_img'] !== '')
                                                <a href="{{ route('all/profile',$rel->user->id) }}" title=""><img src="{{ asset('images/user_img/'.$rel->user['user_img']) }}" class="img-fluid user-img-one" alt=""></a>
                                            @else
                                                <a href="{{ route('all/profile',$rel->user->id) }}" title=""><img src="{{ asset('images/default/user.png') }}" class="img-fluid user-img-one" alt=""></a>
                                            @endif
                                        </div>
                                        ...
                                        <div class="view-dtl">
                                            <div class="view-heading"><a href="{{ route('user.course.show',['id' => $rel->course_id, 'slug' => $rel->courses->slug ]) }}">{{ str_limit($rel->courses['title'], $limit = 30, $end = '...') }}</a></div>
                                            <div class="user-name">
                                                <h6>By <span><a href="{{ route('all/profile',$rel->user->id) }}"> {{ optional($rel->courses->user)['fname'] }}</a></span></h6>
                                            </div>                                            
                                            <div class="rating">
                                                <ul>
                                                    <li>
