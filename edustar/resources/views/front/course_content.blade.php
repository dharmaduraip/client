                    ...
                    <ul>
                        ...
                        <li>
                            <div class="dropdown">
                                ...
                                $progres = ($read_count == 0) ? 0 : ($read_count / $total_count) * 100;
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <div class="about-home-btn">
                                        ...
                                        @else
                                        @php
                                        $random = $progress->certificate_no;
                                        @endphp
                                        @endif
            ...
            <div class="col-lg-8 col-md-8">
                <div class="learning-courses-home-block">
                    ...
                    <span class="vacation-days text-white">({{ __('On Vacation')}})
                        <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="top" data-html="true" title="Vacation Dates: &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;
                        Start Date: {{ date('d-m-Y | h:i:s A',strtotime($course->user->vacation_start)) }} &emsp;
                        End Date:  {{ date('d-m-Y | h:i:s A',strtotime($course->user->vacation_end)) }}"><i class="fa fa-info-circle fa-2x" aria-hidden="true"></i></button>
                    ...
                    @if(!empty($progress->mark_chapter_id))
                    @foreach($progress->mark_chapter_id as $mark_chapter_id)
                    @if ($loop->last)
                    <input type="hidden" value="{{ $mark_chapter_id }}" id="cchp">
                    @endif
                    @endforeach
                    @endif
                    @if(empty($progress) || $progress->mark_chapter_id != $progress->all_chapter_id)
                        <div class="learning-courses-home-btn">
                            <a href="#nav-profile-tab" class="btn btn-primary ctle" title="Continue">{{ __('Continue to Lecture') }}</a>
                        </div>
                    @endif
                    {{-- @if(isset($items))
                        @if(isset($course->chapter[0]->courseclass[0]))
...
<section id="learning-courses" class="learning-courses-about-main-block">
    <div class="container-xl">
        <div class="about-block">
            ...
            <nav>
                <div class="justify-content-between justify-content-sm-start nav nav-tabs" id="nav-tab" role="tablist">
                                ...
                                <div class="col-lg-9 col-md-9">
                                    <div class="content-course-number content-course-number-one">
                                        ...
                                        <ul>
                                            ...
                                            <li class="rgt-10"><a href="{{ $course->user['twitter_url'] }}" target="_blank" title="twitter"><i class="fa fa-twitter"></i></a></li>
                                            @endif
                ...
                <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab">
                    <div class="profile-block">
                        <form method="post" action="{{ action('CourseProgressController@checked', $course->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                            ...
                            @else
                                <div>Not Found Course Chapters!!</div>
                            @endif
                            @php
                            ...
                            <div class="row">
                                ...
                                <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12 col-12">
                                    <div class="coursecontent" id="viewonmb">
                                        <div class="row justify-content-between coursetit">
                                            <div class="col-lg-7 col-md-6 col-sm-6 col-12 mb-3 mb-sm-0" id="chaptertitle">
                                                @if(!empty($first_chapter[0]))
                                                <i class="fa fa-bars" aria-hidden="true"></i> &emsp;<span id="chatit">{{ $first_chapter[0]->chapter_name}}</span>
                                                @endif
                                            </div>
                                            <div class="col-lg-5 col-md-6 col-sm-6 col-12 text-center text-sm-left  prevnex">
                                                <div class="row justify-content-around">
                                                    <div class="col-sm-2 col-6">
                                                        <label class="btn btn-primary precl" @if(!empty($first_class[0])) precls="{{ $first_class[0]->id }}" @endif onclick="changecoursecl('previous')">
                                                            Previous</label>
                                                    </div>
                                                    <div class="col-sm-2 col-6">
                                                        <label class="btn btn-primary nextcl" @if(!empty($first_class[0])) nextcls="{{ $first_class[0]->id }}" @endif onclick="changecoursecl('next')">&nbsp;Next&nbsp;</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="classimage">
                                            @if(!empty($first_class[0]->image))
                                            <div style="width:100%;height:460px;">
                                                <img src="{{ url('images/class/'.$first_class[0]->image) }}" class="couseclim" style="width:100%;height:100%;">
                                            </div>
                                            @endif
                                        </div>
                                        <div class="classvideo">
                                            @if(!empty($first_class[0]->video))
                                            <video src="{{ asset('video/class/'.$first_class[0]->video) }}" controls controlsList="nodownload" width="100%" height="460" class="cvideo">
                                            </video>
                                            @endif
                                        </div>
                                        <div class="classiframe_url">
                                            @if(!empty($first_class[0]->iframe_url))
                                            <p style="font-weight: 500;" class="mt-2">{!! $first_class[0]->iframe_url !!}</p>
                                            @endif
                                        </div>
                                        <div class="classurl">
                                            @if(!empty($first_class[0]->url))
                                            <p style="font-weight: 500;" class="mt-2">Url : <a id="classurlf" href="{{ $first_class[0]->url}}" target="_blank">{{ $first_class[0]->url}}</a></p>
                                            @endif
                                        </div>
                                        <div class="classaudio">
                                            @if(!empty($first_class[0]->audio))
                                            <audio controls controlsList="nodownload">
                                                <source src="{{ asset('public/files/audio/'.$first_class[0]->audio) }}">
                                            </audio>
                                            @endif
                                        </div>

                                        <div class="classpdf">
                                            @if(!empty($first_class[0]->pdf))
                                            <div class="top-bar d-flex flex-wrap align-items-center p-3">
                                                <button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="prev-page">
                                                    <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Prev Page
                                                </button>
                                                <button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="next-page">
                                                    Next Page
                                        ...
                                        <div class="classzip">
                                            @if(!empty($first_class[0]->zip))
                                            <a href="{{ asset('public/files/zip/'.$first_class[0]->zip) }}" download="{{$first_class[0]->zip}}" title="{{ __('Learning Material')}}">Click here download zip file &emsp;<i class="fa fa-download" aria-hidden="true"></i> </a>
                                            @endif
                                        </div>
                                        <div class="classfile mt-3 mb-3">
                                            @if(!empty($first_class[0]->file))
                                            <a href="{{ asset('public/files/class/material/'.$first_class[0]->file) }}" download="{{$first_class[0]->file}}" title="{{ __('Learning Material')}}">Click here download material &emsp;<i class="fa fa-download" aria-hidden="true"></i> </a>
                                            @endif
                                        </div>

                                        <div class="classtitle mb-3">
                                            @if(!empty($first_class[0]))
                                            <span style="font-weight: 500;">Title :</span>
                                            <span id="clstit">{{ $first_class[0]->title}}</span>
                                            @endif
                                        </div>
                                        <div class="classdetail mb-3">
                                            @if(!empty($first_class[0]))
                                            <span style="font-weight: 500;">Details :</span> <span id="clsdet">{{ $first_class[0]->detail}}</span>
                                            @endif
                                        </div>
                                        {{-- <div class="classtype">
                                            @if(!empty($first_class[0]->type)) 
                                                <p style="font-weight: 500;" class="mb-2">Type : {{ $first_class[0]->type }}</p>
                                            @endif
                                        </div> --}}
                                        <div class="classduration">
                                            @if(!empty($first_class[0]->duration))
                                            <p style="font-weight: 500;" class="mt-2">Duration : {{ $first_class[0]->duration }} mins</p>
                                            @endif
                                        </div>
                                        {{-- <div class="classsize">
                                                @if(!empty($first_class[0]->size)) 
                                                    <p style="font-weight: 500;" class="mt-2">Size : {{ $first_class[0]->size }} </p>
                                                @endif
                                            </div> --}}
                                    </div>
                                </div>
                                                ...
                                                @foreach($bigblue as $bbl)
                                                    ...
                                                    <div class="card btm-10">
                                                        <div class="card-header" id="headingThree{{ $bbl->id }}">
                                                            <div class="mb-0">
                                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseThreeBigBlue{{ $bbl->id }}" aria-expanded="false" aria-controls="collapseThree">
                                                        ...
                                                        <div id="collapseThreeBigBlue{{ $bbl->id }}" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                                            ...
                                            <div id="accordion" class="second-accordion">
                                                ...
                                                <div class="card btm-10">
                                                    <div class="card-header" id="headingFour{{ $meeting->id }}">
                                                        <div class="mb-0">
                                                            <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFourZoom{{ $meeting->id }}" aria-expanded="false" aria-controls="collapseFour">
                                                                {{ $meeting['meeting_title'] }}
                                                            </button>
                                                        </div>

                                                    </div>
                                                    <div id="collapseFourZoom{{ $meeting->id }}" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                                            ...
                                            <div class="faq-dtl">
                                                <div id="accordion" class="second-accordion">
                                                    ...
                                                    <div class="card btm-10">
                                                        <div class="card-header" id="headingFour{{ $meeting->id }}">
                                                            <div class="mb-0">
                                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFourGoogle{{ $meeting->id }}" aria-expanded="false" aria-controls="collapseFour">
                                                        ...
                                                        <div id="collapseFourGoogle{{ $meeting->id }}" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                                            ...
                                            <div class="faq-dtl">
                                                <div id="accordion" class="second-accordion">
                                                    ...
                                                    <div class="card btm-10">
                                                        <div class="card-header" id="headingFour{{ $meeting->id }}">
                                                            <div class="mb-0">
                                                                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseFourJitsi{{ $meeting->id }}" aria-expanded="false" aria-controls="collapseFour">
                                                        ...
                                                        <div id="collapseFourJitsi{{ $meeting->id }}" class="collapse" aria-labelledby="headingFour" data-parent="#accordion">
                                        ...
                                        <div class="modal-dialog modal-lg">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="demo-form2" method="post" action="{{ url('addquestion', $course->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                                                        {{ csrf_field() }}
                                                ...
                                                <div class="box box-primary">
                                                    <div class="panel panel-sum">
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="demo-form2" method="post" action="{{ url('addanswer', $ques->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                                                                {{ csrf_field() }}
                                                ...
                                                <div class="box box-primary">
                                                    <div class="panel panel-sum">
                                                        <div class="modal-body">
                                                            ...
                                                            <form id="demo-form2" method="post" action="{{ route('question.report', $ques->id) }}" data-parsley-validate class="form-horizontal form-label-left">
                                                                {{ csrf_field() }}
                    ...
                    <div class="appointment-main-block">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-12">
                                    <div class="assignment-tab-block">
                                        <div class="categories-block assign-tab-one">
                                            <ul>
                                            ...
                                            <div class="d-flex justify-content-start flex-wrap align-items-center">
                                                <div class="delete-assignment">
                                                    ...
                                                    <form method="post" class="mb-0" action="{{url('appointment/delete/'.$appoint->id)}}" ata-parsley-validate class="form-horizontal form-label-left">
                                                        {{ csrf_field() }}
                                                ...
                                                @if($appoint->accept == 1)
                                                <div class="res-assignment"><a href="" data-toggle="modal" data-target="#myModalresponse" title="response">{{ __('Response')}}</a>
                                                </div>
                                                                        ...
                                                                        <div class="instructor-detail">
                                                                            <ul>
                                                                                <li>
                                                                                    ...
                                                                                    <div class="instructor-img btm-30 image-height">
                                                                ...
                                                                <div class="koh-tab-content-body">
                                                                    <div class="koh-faq">
                                                                        <div class="koh-faq-question">
                                                                            ...
                                                                            <i class="fa fa-check-circle" title="pending"></i>
...
<script type="text/javascript">
    ...
    if (count($first_class) > 0) {
        @endphp
        var val = "{{ $first_class[0]->pdf }}";
        if (val != "") {
            const url = "{{ asset('public/files/pdf/'.$first_class[0]->pdf) }}";
            let pdfDoc = null,
                pageNum = 1,
...
<script>
    $(document).ready(function() {
        $(".class-name").click(function() {
            if ($(window).width() <= 991) {
                var sectionTop = $("#viewonmb").offset().top;
                $("html, body").animate({
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on("click", ".ctle", function() {
            $("#nav-profile-tab").trigger("click");
            var ctl = $("#cchp").val();
            if (ctl != undefined && ctl != "") {
                $("#ctlch" + ctl).trigger("click");
            }
    ...
    function classid(id) {
        ...
        $.ajax({
            url: "{{ route('course.class.content') }}",
            type: "POST",
            data: {
                class_id: id,
            },
            success: function(res) {
                $(".classtitle").html('');
                $(".classtitle").append(`<span style="font-weight: 500;">Title :</span>
                                            <span id="clstit">` + res.class.title + `</span>`);
                $(".classdetail").html('');
                $(".classdetail").append(`<span style="font-weight: 500;">Details :</span> <span id="clsdet">` + res.class.detail + `</span>`);
                $("#chatit").html('');
                $("#chatit").append(res.class.coursechapters.chapter_name);
                $(".precl").attr('precls', res.class.id);
                $(".nextcl").attr('nextcls', res.class.id);
                // $(".classtype").html('');
                $(".classimage").html('');
                $(".classvideo").html('');
                $(".classaudio").html('');
                $(".classpdf").html('');
                $(".classiframe_url").html('');
                $(".classzip").html('');
                $(".classfile").html('');
                $(".classurl").html('');
                $(".classduration").html('');
                // $(".classsize").html('');
                // if(res.class.type != null)
                // {
                //     $(".classtype").append(`<p style="font-weight: 500;" class="mb-2">Type : `+res.class.type+`</p> `);   
                // }
                if (res.class.image != null) {
                    $(".classimage").append(`<div style="width:100%;height:460px;"><img src="{{ url('images/class/` + res.class.image + `') }}" class="couseclim mt-2 mb-2" style="width:100%;height:100%;"></div>`);
                }
                if (res.class.video != null) {
                    $(".classvideo").append(`<video src="{{ asset('video/class/` + res.class.video + `') }}" controls controlsList="nodownload" width="100%" height="460" class="cvideo">
                                                        </video>`);
                }
                if (res.class.audio != null) {
                    $(".classaudio").append(`<audio controls class="mt-2 mb-2" controlsList="nodownload">
                                                <source src="{{ asset('public/files/audio/` + res.class.audio + `') }}" >
                                            </audio>`);
                }
                if (res.class.file != null) {
                    $(".classfile").append(`<a href="{{ asset('public/files/class/material/` + res.class.file + `') }}" download="` + res.class.file + `" title="{{ __('Learning Material')}}">Click here download material &emsp;<i class="fa fa-download" aria-hidden="true"></i> </a>`);
                }
                if (res.class.pdf != null) {
                    $(".classpdf").append(`<div class="top-bar d-flex flex-wrap align-items-center p-3">
                            <button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="prev-page">
                            <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Prev Page
                            </button>
                            <button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="next-page">Next Page 
                            <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                            </button><span class="page-info">Page <span id="page-num"></span>of<span id="page-count"></span></span>
                            </div><div class="d-flex justify-content-center">
                            <canvas id="pdf-render"></canvas>
                            </div>

                                                `);
                    const url = "{{ asset('files/pdf') }}/" + res.class.pdf;
                    pdfprenex(url);
                }
                if (res.class.iframe_url != null) {
                    $(".classiframe_url").append(`<p style="font-weight: 500;" class="mt-2">` + res.class.iframe_url + `</p>`);
                    $(".classiframe_url iframe").attr("width", "100%");
                    $(".classiframe_url iframe").attr("height", "460px");
                }
                if (res.class.zip != null) {
                    $(".classzip").append(`<a href="{{ asset('public/files/zip/` + res.class.zip + `') }}" download="` + res.class.zip + `" title="{{ __('Learning Material')}}">Click here download zip file &emsp;<i class="fa fa-download" aria-hidden="true"></i> </a>`);
                }
                if (res.class.url != null) {
                    $(".classurl").append(`<p style="font-weight: 500;" class="mt-2"> Url : <a id="classurlf" href="` + res.class.url + `" target="_blank">` + res.class.url + `</a></p>`);
                }
                if (res.class.duration != null) {
                    $(".classduration").append(`<p style="font-weight: 500;" class="mt-2">Duration : ` + res.class.duration + ` mins</p>`);
                }
                // if(res.class.size != null)
                // {
                //     $(".classsize").append(`<p style="font-weight: 500;" class="mt-3" >Size : `+res.class.size+`</p>`);
                // }
            }
        });
    ...
    function changecoursecl(pos) {
        var class_id = $(".precl").attr('precls');

        if (class_id == undefined) {
            $(".nodata").show();
            $(".nodata").html('');
            $(".nodata").append('No Data Found !!.');
            alert("Please Click Any One Section. Then Click Any One Course Class !!");
        } else {
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
            ...
            $.ajax({
                url: "{{ route('course.classpos.content') }} ",
                type: "POST",
                data: {
                    position: pos,
                    class_id: class_id,
                ...
                success: function(res) {
                    ...
                    if (res.class.pdf != null) {
                        $(".classpdf").append(`<div class="top-bar d-flex flex-wrap align-items-center p-3">
                                <button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="prev-page">
                                <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Prev Page</button><button class="clr-chng btn mb-sm-0 mb-2 mr-2" id="next-page"> Next Page <i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
                                </button><span class="page-info"> Page <span id="page-num"></span> of <span id="page-count"></span>
                                        </span></div><div class="d-flex justify-content-center">
