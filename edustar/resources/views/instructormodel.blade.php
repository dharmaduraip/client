                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="number" class="form-control" name="mobile" id="contact" placeholder="{{ __('Enter Mobile No') }}" value="{{Auth::User()->mobile}}" required onkeydown="javascript: return event.keyCode == 69 ? false : true" style="-moz-appearance: textfield;">
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="file" class="form-control" name="file" id="file" value="" required accept=".jpeg,.png,.jpg,.webp,.pdf">
                        </div>
                         <div class="form-group">
                          <label for="image">{{ __('Upload Image') }}:<sup class="redstar">*</sup></label>
                          <input type="file" class="form-control" name="image"  id="image" required accept=".jpg,.jpeg,.png,.webp">
                        </div>
                      </div>
                    </div>
                    <br>
