...
@section('title', 'Jitsi Meetings - Admin')
@section('maincontent')
...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      ...
      <a href="{{ route('jitsi.create') }}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __("Add Jitsi Meeting")}}</a>
	  @endcan
										  ...
										  <td>
											<div class="dropdown">
												...
												<div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
													<a title="Start Meeting" target="_blank" href="{{url('meetup-conferencing/'.$meeting->meeting_id) }}" class="dropdown-item" ><i class="feather icon-send mr-2"></i>{{ __("Start Meetings")}}</a>
