        ...
        <div class="row">
                            ...
                            <div class="input-group ">
                                ...
                                <div class="custom-file">
                                    ...
                                    <input required type="file" name="background_image" class="custom-file-input"
                                        id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept=".jpg,.jpeg,.png,.gif,.webp">
                    ...
                    <div class="row">
                        ...
                        <table class="courselist table table-bordered table-hover">
                            <thead>
                                <th>{{ __('Courses') }} <span class="text-danger">*</span></th>
                                <th>{{ __('Discount') }} <span class="text-danger">*</span></th>
                                <th>{{ __("Discount type") }} <span class="text-danger">*</span></th>
                                <th>
                                    {{ __('#') }}
                                </th>
                            </thead>
                            ...
                            <tbody>
                                ...
                                @if(!old('course'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <select name="discount_type[]" class="mt-3 form-control" id="discount_type" required>
                                                    <option value="" disabled selected hidden>{{ __('Select discount type') }}</option>
