...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    @can('front-settings.seo-directory.create')
      <a href="{{url('directory/create')}}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __("Add Directory")}}</a>
      @endcan
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('Directory')}}</h5>
                </div>
                <div class="card-body">
                                      ...
                                      <div class="dropdown">
                                          ...
                                          <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                            @can('front-settings.seo-directory.edit')
                                              <a class="dropdown-item"   href="{{ route('directory.show',$dir->id) }}"><i class="feather icon-edit mr-2"></i>{{ __("Edit")}}</a>
                                              @endcan
                                              @can('front-settings.seo-directory.delete')
                                              ...
                                              <a class="dropdown-item"   href="{{ route('directory.view',['id' => $dir->id, 'city' => str_slug(str_replace('-','&',$dir->city))]) }}"><i class="feather icon-eye mr-2"></i>{{ __("View")}}</a>
                                              @endcan
                                          </div>
                                      </div>
                                    </td>
