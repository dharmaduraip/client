        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="form-group col-md-6">
              ...
              <input class="form-control" type="text" name="title" value="{{ filter_var($data->title) }}" placeholder="{{ __('Enter Institute Name') }}" required>
            ...
            <div class="form-group col-md-6">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="custom-file">
                    <input type="file" name="image" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept=".jpg,.jpeg,.png" required >
            ...
            <div class="form-group col-md-12">
              ...
              <textarea name="detail" value="{{ $data->detail }}" rows="5" class="form-control" required>{{ filter_var($data->detail) }}</textarea>
            </div>
