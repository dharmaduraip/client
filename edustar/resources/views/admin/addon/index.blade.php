    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('Addon') }} {{ __('Manager') }}</h5>
                </div> 
                ...
                <div class="table-responsive">
                        ...
                        <?php $i=0;?>
                          @foreach($modules as $module)
                            ...
                            <button type="button" class="btn btn-rounded {{ $module->isStatus(1) ? 'btn-success-rgba' : 'btn-danger-rgba' }}" data-toggle="modal" data-target="#myModal-{{$json['name']}}">
                                  ...
                                  @can('addon.delete')
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete{{$module}}" >
