      ...
      <div class="modal-body">
          ...
          <div class="row">
            <div class="col-sm-12">
                ...
                <option value="" selected disabled>{{ __('PleaseSelect') }} {{ __('Category') }}</option>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <input type="text" class="form-control" name="title" id="exampleInputTitle" placeholder="Enter Your subcategory" value="" required>
            </div>
            <br>
          </div>
          <br>
          ...
          <div class="row">
            <div class="col-sm-12">
              ...
              <input pattern="[/^\S*$/]+" type="text" class="form-control" name="slug" id="exampleInputTitle" placeholder="Enter slug" value="" required>
            </div>
            <br>
          </div>
          <br>
            ...
            <div class="row">
              ...
              <div class="col-md-12 form-group">
                ...
                <br>
                  ...
                  <input id="c101"   class="custom_toggle_add" name="status" type="checkbox" checked/>
