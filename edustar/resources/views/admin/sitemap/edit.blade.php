    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('GenerateSitemap') }}</h5>
                </div> 
                  ...
                  @if(file_exists(public_path().'/'.$path))
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="{{ action('SiteMapController@download') }}" method="POST" enctype="multipart/form-data">
				                ...
				                {{ method_field('POST') }}
                            <div class="form-group">
                            <button type="submit" class="float-left btn btn-primary-rgba"><i class="feather icon-download"></i> {{ __('DownloadSitemap') }}</button>
                            </div>
			                 </form>
