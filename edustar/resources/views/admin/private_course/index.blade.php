    ...
    <div class="widgetbar">
      ...
      <button type="button" class="float-right btn btn-danger-rgba mr-2 multipledel" data-toggle="modal" data-target="#bulk_delete"><i
        ...
        {{-- @can(' private-course.create') --}}
          <a href="{{ route('private-course.create') }}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{__('Add Private Course')}}</a>
        {{-- @endcan --}}
    </div>                        
</div>
                                      ...
                                      <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                          @can('private-course.edit')
                                            <a class="dropdown-item" href="{{ route('private-course.show',$course->id) }}"><i class="feather icon-edit mr-2"></i>{{__('Edit')}}</a>
                                            @endcan
                                            @can('private-course.delete')
...
$.ajaxSetup({
  ...
  $(".multipledel").click(function(){
     ...
     if(count == "0")
     {
         alert("Atleast One Private Course is required to be selected");
         return false;
     }
