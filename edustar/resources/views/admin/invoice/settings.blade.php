        ...
        <div class="card-body">
          ...
          <form action="{{ route('invoice.update') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6">
                  <label class="text-dark">{{ __('Signature') }} :<span class="redstar">*</span></label>
                  <div class="input-group">
                    <input required readonly id="image" for="signature" name="signature" type="text" class="form-control" value="{{$settings->signature != NULL ? $settings->signature : '' }}">
