...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    @can('front-settings.testimonial.create')
      <a href="{{url('testimonial/create')}}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __("Add Testimonal")}}</a>
      @endcan
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="box-title">{{ __('Testimonial')}}</h5>
              </div>
              <div class="card-body">
                              ...
                              <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
                                    @can('front-settings.testimonial.edit')
                                      <a class="dropdown-item" href="{{url('testimonial/'.$p->id.'/edit')}}"><i class="feather icon-edit mr-2"></i>{{ __("Edit")}}</a>
                                      @endcan
                                      @can('front-settings.testimonial.delete')
