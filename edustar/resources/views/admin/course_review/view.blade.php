...
<div class="col-md-4 col-lg-4">
    <a href="{{ url('coursereview') }}" class="float-right btn btn-primary mr-2"><i
          ...
          <div class="card-body">
            ...
            <form action="{{url('coursereview/'.$course->id)}}" method="POST" enctype="multipart/form-data">
              ...
              <div class="row">
                ...
                <div class="col-md-12">
                  <div style="{{ $course->status == '0' ? '' : 'display:none' }}" id="sec1_one">
                    <label for="exampleInputDetails">{{ __('Reason for Rejection') }}:</label>
              ...
              <div class="form-group mt-3">
                <a href="javascript:window.location.reload(true)" type="reset" class="btn btn-danger"><i class="fa fa-ban"></i>
                  {{ __('Reset') }}</a>
