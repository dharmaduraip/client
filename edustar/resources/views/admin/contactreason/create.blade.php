...
@section('title', 'Add Contact us-reason - Admin')
@section('maincontent')
@component('components.breadcumb',['fourthactive' => 'active'])
@slot('heading')
   {{ __('Add Contactreason') }}
@endslot
@slot('menu1')
{{ __('Add Contactreason') }}
@endslot
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('Add Contact-reason') }}</h5>
                </div> 
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" value="{{ old('reason') }}" autofocus="" class="form-control @error('title') is-invalid @enderror" placeholder="{{ __('Please Enter the reason to contact us') }}" name="reason" required="">
                                                            @error('reason')
