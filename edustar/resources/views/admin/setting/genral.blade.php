    ...
    <div class="row">
        ...
        <div class="bg-info-rgba col-md-12 ml-3 mr-3 mb-3">
            ...
            <div class="col-md-12">
                <div class="row" style="{{ $setting['map_enable'] == 'map' ? '' : 'display:none' }}" id="sec1_one">
                    <div class="col-md-4">
                        <label class="text-dark" for="map_lat">{{ __('MapLatitude') }}:</label>
                        <input value="{{ $setting->map_lat }}" name="map_lat" placeholder="Enter Latitude" type="text"
                            class="{{ $errors->has('map_lat') ? ' is-invalid' : '' }} form-control">
                    </div>
                    <div class="col-md-4">
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <div>
                            <small>{{ __('(If you enable it, a welcome email will be sent to user\'s register email id, make sure you updated your mail setting in Site Setting >> Mail Settings before enable it.)') }}</small>
                ...
                <div class="col-md-4">
                    ...
                    <div style="{{$gsetting->watch_enable == 1 ? '' : 'display: none' }}" id="update-password">
                        <div class="form-group">
                          ...
                          <input type="number" name="watch_time" value="{{ $gsetting->watch_time }}" class="form-control"
        ...
        <div class="col-md-6">
            <div class="row mb-4">
                ...
                <div class="bg-primary-rgba p-3 col-md-3">
                    @if($image = @file_get_contents(public_path().'/images/logo/'.$setting->footer_logo))
                    <img src="{{ url('/images/logo/'.$setting->footer_logo) }}"
        ...
        <div class="form-group col-md-6">
            ...
            <div class="row">
                ...
                <div class="bg-primary-rgba p-3 col-md-3">
                    @if($image = @file_get_contents(public_path().'/images/logo/'.$setting->preloader_logo))
                    <img src="{{ url('/images/logo/'.$setting->preloader_logo) }}"
                        class="logo_img img-fluid" />
                    @endif
                </div>
            </div>
