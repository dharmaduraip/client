...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
        ...
        <a href="{{url('refundpolicy/create')}}"  class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{ __('Add Refund Policy') }} </a>
        @endcan
    </div>                        
</div>
              ...
              <td>
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                        ...
                        <a class="dropdown-item" href="{{url('refundpolicy/'.$policy->id.'/edit')}}"><i class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                        @endcan
                        @can('refund-policy.delete')
                        <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete{{ $policy->id }}" >
...
<script>
    ...
    $(document).on("change",".refund",function() {
        ...
        $.ajax({
            ...
            success: function(data)
            {
                ...
                {
                    alert("You can't change this status. because, This refund policy already used in some course.");
    ...
    $(".multipledel").click(function(){
        ...
        if(count == "0")
        {
            alert("Atleast One Refund Policy is required to be selected");
            return false;
        }
