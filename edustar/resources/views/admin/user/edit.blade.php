            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  ...
                  <select id="upload_id" class="form-control select2" name="state_id">
                    ...
                    @foreach ($states as $s)
                    <option value="{{ $s->state_id}}" {{ $user->state_id==$s->id ? 'selected' : '' }}>
                      {{ $s->name}}
                    </option>
                    @endforeach
                ...
                <div class="form-group">
                  ...
                  <select class="form-control select2" name="role">
                    {{-- <option {{ $user->role == 'user' ? 'selected' : ''}} value="user">{{ __('User') }}</option> --}}
              ...
              <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="checkbox" class="custom_toggle stch{{ $user->id }}" name="status" @if($user->role=="admin" || $user->role=="instructor") onchange="checkstatus({{ $user->id }})" @endif
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group position-relative">
                    ...
                    <input type="password" name="password" class="form-control"
                      placeholder="{{ __('Enter') }} {{ __('Password') }}" id="password">
                ...
                <div class="form-group position-relative" >
                  ...
                  <input type="password" name="confirmpassword" class="form-control"
                    placeholder="{{ __('Confirm Password') }}" id="confirmpassword">
