...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    @can('instructor-pending-payout.manage')
        <button type="button" class="float-right btn btn-info-rgba mr-2" data-toggle="modal" data-target="#bulk_delete"><i class="fa fa-credit-card" aria-hidden="true"></i> {{ __('Pay Selected') }}</button>
    @endcan
