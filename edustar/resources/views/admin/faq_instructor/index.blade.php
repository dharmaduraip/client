...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
      @can('faq.faq-instructor.delete')
  <button type="button" class="float-right btn btn-danger-rgba mr-2 multipledel" data-toggle="modal" data-target="#bulk_delete"><i class="feather icon-trash mr-2"></i> {{ __('Delete Selected') }}</button>
            @endcan
            @can('faq.faq-instructor.create')
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            @can('faq.faq-instructor.edit')
                                            <a class="dropdown-item" href="{{url('faqinstructor/'.$p->id.'/edit')}}"><i class="feather icon-edit mr-2"></i>{{ __('Edit') }}</a>
                                            @endcan
                                            @can('faq.faq-instructor.delete')
...
<script type="text/javascript">
    $( function() {
     ...
     update: function (e, u) {
      ...
      $.ajax({
          url: "{{ route('faqinstructor_reposition') }}",
          type: 'get',
          data: data,
          dataType: 'json',
...
$(".multipledel").click(function(){
     ...
     if(count == "0")
     {
         alert("Atleast One Faq Instructor is required to be selected");
         return false;
     }
