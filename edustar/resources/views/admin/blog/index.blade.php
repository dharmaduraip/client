...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
        ...
        @endcan
        @can('blogs.create')
        <a href="{{url('blog/create')}}" class="float-right btn btn-primary-rgba mr-2"><i class="feather icon-plus mr-2"></i>{{ __('Add Blog') }}</a>
        @endcan
    </div>
</div>
@endslot
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <input type='checkbox' form='bulk_delete_form' class='check filled-in material-checkbox-input' name='checked[]' value="{{ $item->id }}" id='checkbox{{ $item->id }}'>
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <form id="bulk_delete_form" method="post" action="{{ route('blog.bulk.delete') }}">
                                                            @csrf
                                                            @method('POST')
                                    ...
                                    <td>
                                        ...
                                        <img src="{{ asset('images/blog/'.$item->image) }}" class="img-responsive img-circle">
                                        @endif
                                    </td>
                                    <td>
                                        {{$item->user->fname}}
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                ...
                                                @endcan
                                                @can('blogs.delete')
                                                <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete{{ $item->id }}">
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>{{ __('Do you really want to delete')}} <b>{{$item->heading}}</b>?</p>
                                                    </div>
                                                    <div class="modal-footer">
...
<script>
    ...
    $(".multipledel").click(function() {
        ...
        if (count == "0") {
            alert("Atleast One Blog is required to be selected");
            return false;
        }
