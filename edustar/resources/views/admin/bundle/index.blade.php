...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    ...
    <a href="{{url('bundle/create')}}" class="float-right btn btn-primary-rgba mr-2"><i
        class="feather icon-plus mr-2"></i>{{ __('Add Bundle Course') }}</a>
    @endcan
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-box">{{ __('Bundle Courses') }}</h5>
        </div>
        <div class="card-body">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <div class="btn btn-rounded {{ $cat->is_subscription_enabled== '1' ? 'btn-success-rgba' : 'btn-danger-rgba' }}" >
                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                        ...
                        <a class="dropdown-item" href="{{ route('bundle.show',$cat->id) }}"><i
                        ...
                        <button type="button" class="dropdown-item" data-toggle="modal"
                          data-target="#exampleStandardModal{{ $cat->id }}">
...
<script>
  ...
  $(".multipledel").click(function(){
     ...
     if(count == "0")
     {
         alert("Atleast One Bundle Course is required to be selected");
         return false;
     }
