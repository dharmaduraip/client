...
<div class="col-md-4 col-lg-4">
    <div class="widgetbar">
        <a href="{{url('admin/menu/create')}}" class="float-right btn btn-primary-rgba mr-2"><i
                class="feather icon-plus mr-2"></i>{{ __('Add Menus') }} </a>
    </div>
</div>
        ...
        <div class="col-lg-12">
            <div class="card m-b-30">
                <div class="card-header">
                    <h5 class="box-title">{{ __('All Menu') }} </h5>
                </div>
                <div class="card-body">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                                <a class="dropdown-item"
                                                    href="{{url('admin/menu/'.$policy->id.'/edit')}}"><i
