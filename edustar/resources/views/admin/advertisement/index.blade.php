...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
    @can('front-settings.advertisement.create')
      <a href="{{url('advertisement/create')}}" class="btn btn-primary-rgba"><i class="feather icon-plus mr-2"></i>{{ __("Add Advertisement")}}</a>
      @endcan
      ...
      <div class="col-lg-12">
          <div class="card m-b-30">
              <div class="card-header">
                  <h5 class="box-title">{{ __('Advertisement')}}</h5>
              </div>
              <div class="card-body">
                                ...
                                <div class="dropdown">
                                  ...
                                  <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                    @can('front-settings.advertisement.edit')
                                      <a class="dropdown-item" href="{{url('advertisement/'.$adv->id)}}"><i
