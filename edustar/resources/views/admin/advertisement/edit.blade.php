    ...
    <div class="col-lg-12">
      <div class="card m-b-30">
        <div class="card-header">
          <h5 class="card-title">{{ __('Edit') }} {{ __('Advertisement') }}</h5>
        </div>
        <div class="card-body">
              ...
              <div class="form-group col-md-6">
                ...
                <div class="input-group mb-3">
                  ...
                  <div class="custom-file">
                    <input type="file" name="image1" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="image/png, image/jpeg, image/gif, image/jpg, image/svg">
                ...
                <small class="text-muted"><i class="fa fa-question-circle"></i> {{ __('RecommnadedSize') }} (1375 x 409px)</small>
              </div>
              <div class="form-group col-md-6">
                <label for="exampleInputDetails">{{ __('EnterURL') }}:</label>
                <input type="title" class="form-control" name="url1" id="exampleInputTitle" value="{{ $advs->url1 }}" placeholder="{{ __('EnterURL') }}" >
