                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade active show" id="v-pills-dashboard" role="tabpanel"
                        ...
                        <ul class="vertical-menu">
                            ...
                            <!-- user start  -->
                            <li
                                class="{{ Nav::isRoute('user.index') }} {{ Nav::isRoute('user.add') }} {{ Nav::isRoute('user.edit') }}{{ Nav::isRoute('alluser.index') }} {{ Nav::isRoute('alluser.add') }} {{ Nav::isRoute('alluser.edit') }}{{ Nav::isRoute('allinstructor.index') }} {{ Nav::isRoute('allinstructor.add') }} {{ Nav::isRoute('allinstructor.edit') }}{{ Nav::isResource('roles') }}">
                                ...
                                <ul class="vertical-submenu">
                                    @can('users.view')
                                    <li>
                                        <a class="{{ Nav::isResource('user.index') }}"
                                    ...
                                    <li>
                                        <a class="{{ Nav::isResource('user.verify') }}"
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('subscription/plan') }}"><a
                                            href="{{url('subscription/plan')}}">{{ __('InstructorPlan') }}</a>
                                    </li>
                                    @endif
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li
                                        ...
                                        <a href="javaScript:void();">
                                            <i class=""></i> <span>{{ __('Categories') }}</span><i
                                                class="feather icon-chevron-right"></i>
                                        </a>
                                        <ul class="vertical-submenu">
                                            @can(['categories.view'])
                                            <li class="{{ Nav::isResource('category.index') }}"><a
                                                    href="{{url('category')}}">{{ __('Category') }}</a>
                                            </li>
                                            @endcan
                                            @can(['subcategories.view'])
                                            <li class="{{ Nav::isResource('subcategory.index') }}"><a
                                    ...
                                    <li class="{{ Nav::isResource('private-course') }}"><a
                                            href="{{url('private-course')}}"><span>{{ __('Private Courses') }}</span></a>
                                    </li>
                                    @endcan
                            ...
                            <li class="{{ Nav::isRoute('onesignal.settings') }}"><a
                                    href="{{route('onesignal.settings')}}"><i
                                        class="feather icon-navigation text-secondary"></i><span>{{ __('Push Notification') }}</span></a>
                            </li>
                            @endcan 
                            ...
                            <!-- pages start -->
                            @can(['pages.view'])
                            <li class="{{ Nav::isResource('page.index') }}"><a
                            ...
                            <li class="{{ Nav::isResource('usermessage') }}"><a href="{{url('usermessage')}}"><i
                                        class="feather icon-phone-call text-secondary"></i><span>{{ __('ContactUs') }}</span>
                                </a>
                            </li>
                            @endcan
                            @can('job.manage')
                            ...
                            <li class="{{ Nav::isRoute('get.api.key') }}">
                                ...
                                class="feather icon-share text-secondary"></i><span>{{ __('GetAPIKeys') }}</span></a>
                            </li>
                            @endcan --}}
                            @can(['currency.view'])
                            ...
                            <li
                                ...
                                <ul class="vertical-submenu">
                                    ...
                                    <li class="{{ Nav::isResource('slider.index') }}"><a
                            ...
                            <li class="{{ Nav::isRoute('activity.index') }}"><a href="{{route('activity.index')}}">
                                    <i
                                        class="feather icon-help-circle text-secondary"></i><span>{{ __('ActivityLog') }}</span>
                                </a></li>
                           ...
                           <!--  <li class="{{ Nav::isResource('admin-addon') }}">
                            ...
                            <li class="{{ Nav::isRoute('update.process') }}">
                                <a href="{{route('update.process')}}"><i class="feather icon-share text-secondary"></i><span>{{ __('UpdateProcess') }}</span></a>
                            </li>
                            @endcan 
