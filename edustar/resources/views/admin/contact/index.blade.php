...
<div class="col-md-4 col-lg-4">
  <div class="widgetbar">
        ...
        <div class="d-flex">
            ...
            <a href="{{url('contactreason')}}" class="float-right btn btn-success-rgba mr-2"><i class="feather icon-eye mr-2"></i>{{ __('View Reason') }}</a>
        </div>
        @endcan
  </div>
</div>
    ...
    <div class="col-lg-12">
        ...
        <div class="card m-b-30">
                ...
                <div class="card-header">
                    <h5 class="card-box">{{ __('AllMessage') }}</h5>
                </div> 
                ...
                <div class="table-responsive">
                        ...
                        <?php $i++;?>
                            ...
                            <div class="modal-dialog modal-sm">
                                ...
                                <td>{{ str_limit($item->reason, $limit = 50, $end = '...') }}</td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                            @can('contact-us.manage')
                                            <a class="dropdown-item" href="{{route('usermessage.edit',$item->id)}}"><i class="feather icon-eye mr-2"></i>{{ __('View') }}</a>
