										...
										<div class="row">
											...
											<div class="form-group col-md-6">
												...
												<div class="custom-file">
													<input type="file" class="custom-file-input" id="inputGroupFile01" name="bg_image" aria-describedby="inputGroupFileAddon01" accept="image/png, image/jpeg, image/gif, image/jpg, image/svg">
