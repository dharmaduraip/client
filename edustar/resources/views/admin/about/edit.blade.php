							...
							<div class="col-md-12">
								...
								<div class="row" style="{{ $data['three_enable']==1 ? '' : 'display:none' }}" id="sec_three">
									...
									<div class="col-md-4">
										...
										<input value="{{ $data['three_countone'] }}" name="three_countone" type="number" class="form-control" placeholder="Enter Count" />
									</div>

									<div class="col-md-4">
										<label class="text-dark" for="three_counttwo">{{ __('Section Three Counter Two :') }} <span class="text-danger">*</span></label>
										<input value="{{ $data['three_counttwo'] }}" name="three_counttwo" type="number" class="form-control" placeholder="Enter Count" />
									</div>

									<div class="col-md-4">
										<label class="text-dark" for="three_countthree">{{ __('Section Three Counter Three :') }} <span class="text-danger">*</span></label>
										<input value="{{ $data['three_countthree'] }}" name="three_countthree" type="number" class="form-control" placeholder="Enter Count" />
										<br>
									</div>

									<div class="col-md-4">
										<label class="text-dark" for="three_countfour">{{ __('Section Three Counter Four :') }} <span class="text-danger">*</span></label>
										<input value="{{ $data['three_countfour'] }}" name="three_countfour" type="number" class="form-control" placeholder="Enter Count" />
									</div>

									<div class="col-md-4">
										<label class="text-dark" for="three_countfive">{{ __('Section Three Counter Five :') }} <span class="text-danger">*</span></label>
										<input value="{{ $data['three_countfive'] }}" name="three_countfive" type="number" class="form-control" placeholder="Enter Count" />
									</div>

									<div class="col-md-4">
										<label class="text-dark" for="three_countsix">{{ __('Section Three Counter Six :') }} <span class="text-danger">*</span></label>
										<input value="{{ $data['three_countsix'] }}" name="three_countsix" type="number" class="form-control" placeholder="Enter Count" />
										<br>
									</div>
						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="row" style="{{ $data['six_enable']==1 ? '' : 'display:none' }}" id="sec_six">
									...
									<div class="col-md-4">
										<label class="text-dark" for="link_two">{{ __('Section Six Link') }} : <span class="text-danger">*</span></label>
