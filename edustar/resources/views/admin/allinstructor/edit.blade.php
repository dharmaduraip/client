        ...
        <div class="card-body ml-2">
          <form action="{{ route('allinstructor.update',$user->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <div class="form-group" >
                  ...
                  <input type="password" name="confirmpassword" class="form-control"
                    placeholder="{{ __('Please') }} {{ __('ConfirmPassword') }}">
                </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <label for="role">{{ __('SelectRole') }}:</label>
                  @if(Auth::User()->role=="admin")
                  <select class="form-control select2" name="role">
                    <option {{ $user->role == 'instructor' ? 'selected' : ''}} value="instructor">{{ __('Instructor') }}
                    </option>
                  </select>
                ...
                <div class="form-group">
                  ...
                  <input value="{{ $user->pin_code }}"
                    placeholder="{{ __('Please') }} {{ __('Enter') }} {{ __('Pincode') }}" type="text"
                ...
                <div class="form-group">
                  ...
                  <small class="text-muted"><i class="fa fa-question-circle"></i>
                    {{ __('Recommendedsize') }} (1375 x 409px)</small>
