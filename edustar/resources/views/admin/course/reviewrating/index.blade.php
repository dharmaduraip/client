  ...
  <div class="col-lg-12">
      <div class="card m-b-30">
          <div class="card-header">
            ...
            <button type="button" class="btn btn-danger-rgba mr-2 multipledel7" data-toggle="modal" data-target="#bulk_deletereviewrating"><i
...
{{-- course edit review rating script start --}}
...
{{-- course edit review rating script end --}}
