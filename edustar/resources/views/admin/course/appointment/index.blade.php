      ...
      <div class="card m-b-30">
          <div class="card-header">
            <div class="d-flex justify-content-between">
              ...
              <button type="button" class="btn btn-danger-rgba mr-2 multipledel11" data-toggle="modal" data-target="#bulk_delete11"><i class="feather icon-trash mr-2"></i> {{__('Delete Selected')}}</button>
            </div>
          </div>
                          ...
                          <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                                    ...
                                    <a class="dropdown-item" href="{{url('appointment/'.$appoint->id)}}"><i class="feather icon-edit mr-2"></i>Edit</a>
