  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <button type="button" class=" btn btn-danger-rgba mr-2 multipledel3" data-toggle="modal" data-target="#bulk_delete3"><i
        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            <form id="demo-form2" method="post" action="{{ route('coursechapter.store') }}" data-parsley-validate
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e">{{ __('Chapter Name') }}: <span class="redstar">*</span>
                  </label>
                ...
                <div class="col-md-12">
                  <div class="input-group mb-3">
                    ...
                    <div class="custom-file">
                      <input type="file" class="custom-file-input" id="file" aria-describedby="inputGroupFileAddon01" accept=".jpg,.jpeg,.png">
