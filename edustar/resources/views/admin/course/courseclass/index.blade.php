  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <button type="button" class="btn btn-danger-rgba mr-2 multipledel4" data-toggle="modal" data-target="#bulk_delete4"><i
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      ...
                      @endcan
                      @can('course-class.delete')
                      <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete_chapter{{ $cat->id}}">
                        <i class="feather icon-delete mr-2"></i>{{ __("Delete") }}</a>
                      @endcan
                    </div>
                  </div>
                 <div class="modal fade bd-example-modal-sm" id="delete_chapter{{ $cat->id }}" role="dialog"
                    aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="panel panel-sum">
              <div class="modal-body">
                <form enctype="multipart/form-data" id="demo-form2" method="post"
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <label for="exampleInputDetails">{{ __('Chapter Name') }}:<sup
                          class="redstar">*</sup></label>
                      <select name="course_chapters" class="form-control select2" required>
                        <option value="" selected disabled>{{ __('Choose Chapter Name') }}</option>
                  ...
                  <div class="row">
                    <div class="col-md-12 btm-20">
                      ...
                      <select name="type" id="filetype" class="form-control select2" required>
                        <option value="" selected disabled>{{ __('Choose File Type') }}</option>
                    ...
                    <div class="col-md-12" id="audioUpload" style="display:none">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="audioupload" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="audio/*">
                    ...
                    <div class="col-md-12" id="imageUpload" style="display:none">
                      ...
                      <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="image" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="image/png, image/gif, image/jpeg">
                            <label class="custom-file-label" for="inputGroupFile01">{{__('Choose file')}}</label>
                        </div>
                      </div>
                      <!-- =========== -->
                    ...
                    <div class="col-md-12 btm-20" id="videotype" style="display:none">
                      ...
                      <input type="radio" name="checkVideo" id="ch2"
                        value="uploadvideo">&nbsp;{{ __('Upload Video') }}
                      &emsp;
                      <input type="radio" name="checkVideo" id="ch9"
                        value="iframeurl">&nbsp;{{ __('Iframe URL') }}
                      &emsp;
                      <input type="radio" name="checkVideo" id="ch10"
                        value="liveurl">&nbsp;{{ __('Live Class') }}
                      &emsp;
                    ...
                    <div class="col-md-12" id="zipUpload" style="display:none">
                      <label for="">{{ __('Upload Zip') }}: </label>
                       ...
                       <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="uplzip" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="application/zip">
                            <label class="custom-file-label" for="inputGroupFile01">{{__('Choose file')}}</label>
                        </div>
                      </div>
                      <!-- =========== -->
                  ...
                  <div class="row" style="display:none">
                    <div class="col-md-12" id="previewUrl">
                      ...
                      <div id="document11">
                        <label for="exampleInputSlug">Preview {{ __('Upload Video') }}:</label>
                         <!-- =========== -->
                       <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{__('Upload')}}</span>
                      ...
                      <div id="document22">
                        <label for="">Preview {{ __('URL') }}: </label>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      ...
                      <label for="exampleInputDetails">{{ __('Learning Material') }}</label> - <p
                        class="inline info">{{__('eg: zip files only allowed')}}</p>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="file" id="inputGroupFile01" accept=".zip" aria-describedby="inputGroupFileAddon01">
                            <label class="custom-file-label" for="inputGroupFile01">{{__('Choose file')}}</label>
                        </div>
