          ...
          <form enctype="multipart/form-data" id="demo-form" method="post" action="{{url('courseclass/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
            ...
            @if($cate->type =="video")
              <div class="row">
                <div class="col-md-12" id="videotype">
                  ...
                  <input type="radio" name="checkVideo" id="ch2" value="uploadvideo" {{ $cate->video !="" ? 'checked' : "" }}>&nbsp;{{ __('Upload Video') }}&emsp;
                  <input type="radio" name="checkVideo" id="ch9" value="iframeurl" {{ $cate->iframe_url !="" ? 'checked' : "" }}>&nbsp;{{ __('Iframe URL') }}&emsp;
                  <input type="radio" name="checkVideo" id="ch10" value="liveurl" {{ $cate->date_time !="" ? 'checked' : "" }}>&nbsp;{{ __('Live Class') }}&emsp;
              ...
              <div class="row">
                <div class="col-md-12">
                  <div id="videoUpload" @if($cate->url !=NULL || $cate->iframe_url !=NULL || $cate->aws_upload !=NULL) style="display:none" @endif >
                    <label for="">{{ __('Upload Video') }}: </label>
                      <!-- =========== -->
                      <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="video_upld" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="video/*"/>
                            <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
                        </div>
                      </div>
                      <!-- =========== -->
                    ...
                    @if($cate->video !="")
                      <video src="{{ asset('video/class/'.$cate->video) }}" controls width="650" height="500">
                      </video>
                    @endif
                  </div>
                </div>
            ...
            @if($cate->type =="audio")
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    ...
                    <input type="radio" name="checkAudio" id="ch12"  {{ $cate->audio !="" ? 'checked' : "" }} value="uploadaudio"> {{ __('Upload Audio') }}
                  </div>
                </div>
                ...
                <div class="form-group">
                  <div class="col-md-12">
                    <div id="audioUpload">
                    <label for="">{{ __('Upload Audio') }}:</label>
                    <!-- =========== -->
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="audio" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="audio/*">
                            <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
                        </div>
                      </div>
                      <!-- =========== -->
            ...
            @if($cate->type =="image")
              ...
              <div class="col-md-7" id="imagetype">
                ...
                <input type="radio" name="checkImage" id="ch4"  {{ $cate->image !="" ? 'checked' : "" }} value="uploadimage"> {{ __('Upload Image') }}
              </div>
                ...
                <div class="col-md-12">
                  <div id="imageUpload">
                    ...
                    <div class="input-group mb-3">
										...
										<div class="custom-file">
											<input type="file" class="custom-file-input" id="inputGroupFile01" name="image" aria-describedby="inputGroupFileAddon01" accept="image/png, image/gif, image/jpeg">
											<label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
										</div>
										</div>
            ...
            @if($cate->type =="zip")
              <div class="form-group">
                <div class="col-md-12" id="ziptype">
                  ...
                  <input type="radio" name="checkZip" id="ch6"  {{ $cate->zip !="" ? 'checked' : "" }} value="uploadzip"> {{ __('Upload Zip') }}
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-12">
                  ...
                  <div class="input-group mb-3">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" name="zip" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept=".zip">
                            <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
                        </div>
                      </div>
                      <!-- =========== -->
            ...
            @if($cate->type =="pdf")
              <div class="col-md-12" id="pdftype">
                ...
                <input type="radio" name="checkPdf" id="ch9"  {{ $cate->pdf !="" ? 'checked' : "" }} value="uploadpdf"> {{ __('Upload Pdf') }}
              </div>


              <div class="form-group">
                <div class="col-md-12" id="pdfURL">
                  <div id="pdfURL">
                    <label for=""> {{ __('URL') }}: </label>
              ...
              <div class="col-md-7" id="pdfUpload" >
                <label for=""> {{ __('Upload Pdf') }}:</label>
                <!-- =========== -->
                <div class="input-group mb-3">
                  <div class="input-group-prepend">
                      <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                  ...
                  <div class="custom-file">
                      <input type="file" class="custom-file-input" name="pdf" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="application/pdf">
                      <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
                  </div>
                </div>
                <!-- =========== -->
            ...
            <div class="row" style="display:none">
              <div class="col-md-12">
                ...
                <div @if($cate->preview_type =="url" ) class="display-none" @endif id="document11">
                  <label for="exampleInputSlug">{{ __('Preview') }} {{ __('Upload Video') }}: <sup class="redstar">*</sup></label>
                   <!-- =========== -->
                   <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" value="{{ $cate->video }}" name="video" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="video/*"/>
                            <label class="custom-file-label" for="inputGroupFile01" >{{ __('Choose file') }}</label>
                        </div>
                      </div>
                      <!-- =========== -->
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="exampleInputDetails">{{ __('Learning Material') }}</label> - <p class="inline info">eg: zip files only allowed</p>
                  <!-- =========== -->
                  <div class="input-group mb-3">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="inputGroupFileAddon01">{{ __('Upload') }}</span>
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input {{ $errors->has('file') ? ' is-invalid' : '' }}" value="{{ $cate->file }}" name="file" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept=".zip">
                            <label class="custom-file-label" for="inputGroupFile01">{{ __('Choose file') }}</label>
                        </div>
                      </div>
                      <!-- =========== -->
            ...
            @if($cate->courses->drip_enable == 1)
              ...
              <div class="row"> 
                ...
                <div class="col-md-6" @if($cate->drip_type == 'days' || $cate->drip_type == NULL) style="display: none;" @endif id="dripdate">
                  ...
                  <small class="text-muted text-info"><i class="fa fa-question-circle"></i> {{ __('When section should be unlock') }}.</small>
                ...
                <div class="col-md-6" @if($cate->drip_type == 'date' || $cate->drip_type == NULL) style="display: none;" @endif id="dripdays">
                  ...
                  <small class="text-muted text-info"><i class="fa fa-question-circle"></i> {{ __('Enter days') }}.</small>
                </div>
              </div>
              <br>
...
<script>
 ...
 @if($cate->type =="audio")
  <script>
    (function($) {
    "use strict";
       var checkAudio = $('input[name="checkAudio"]:checked').val();
      if(checkAudio == 'uploadaudio') {
         $('#audioURL').hide();
         $('#audioUpload').show();
      } else {
         $('#audioURL').show();
 ...
 @if($cate->type =="image")
  <script>
    (function($) {
    "use strict";
      var checkImage = $('input[name="checkImage"]:checked').val();
      if(checkImage == 'uploadimage') {
         $('#imageURL').hide();
         $('#imageUpload').show();
      } else {
         $('#imageURL').show();
 ...
 @if($cate->type =="zip")
  <script>
    (function($) {
    "use strict";
      var checkZip = $('input[name="checkZip"]:checked').val();
      if(checkZip == 'uploadzip') {
         $('#zipURL').hide();
         $('#zipUpload').show();
      } else {
         $('#zipURL').show();
 ...
 @if($cate->type =="pdf")
  <script>
    (function($) {
    "use strict";
      var checkPdf = $('input[name="checkPdf"]:checked').val();
      //alert(checkPdf);
      if(checkPdf == 'uploadpdf') {
         $('#pdfURL').hide();
         $('#pdfUpload').show();
      } else {
         $('#pdfURL').show();
