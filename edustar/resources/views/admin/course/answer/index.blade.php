...
<div class="col-md-4 col-lg-4">
  <a href="{{ url('course/create/'. $questions[0]->course_id) }}" class="float-right btn btn-primary ml-2"><i class="feather icon-arrow-left mr-2"></i>{{__('Back')}}</a>
  @can('answer.create')
          ...
          <div class="panel panel-sum">
            <div class="modal-body">
              <form id="demo-form2" method="post" action="{{url('courseanswer/')}}" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="row">
                  <div class="col-md-12">
                    <label  for="exampleInputTit1e">{{ __('Select Question') }}:<sup class="redstar">*</sup></label>
                    <br>
