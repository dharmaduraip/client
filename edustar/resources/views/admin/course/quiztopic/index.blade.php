  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <button type="button" class="btn btn-danger-rgba mr-2 multipledel10" data-toggle="modal" data-target="#bulk_delete10"><i
        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            <form id="demo-form2" method="post" action="{{url('admin/quiztopic/')}}" data-parsley-validate
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputDetails">{{ __('Quiz Description') }}:<sup
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputTit1e">{{ __('Quiz Timer') }}:<span class="redstar">*</span>
                  </label>
