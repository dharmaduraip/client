...
<a href="{{ url('course/create/'. $cate->main_course_id) }}" class="float-right btn btn-primary-rgba"><i class="feather icon-arrow-left mr-2"></i>{{ __('Back') }}</a>
</div>
@endslot
      ...
      <div class="card m-b-30">
        ...
        <div class="card-body ml-2">
          <form id="demo-form" method="post" action="{{url('relatedcourse/'.$cate->id)}}"data-parsley-validate class="form-horizontal form-label-left">
            ...
            <div class="row">
              <div class="col-md-12">
                <label for="exampleInputSlug">{{ __('Related Course') }}</label>
