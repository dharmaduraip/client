  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <button type="button" class="btn btn-danger-rgba mr-2 multipledel5" data-toggle="modal" data-target="#bulk_delete5">
          <i
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      ...
                      <a class="dropdown-item" href="{{url('relatedcourse/'.$cat->id)}}"><i
                          ...
                          @endcan
                          @can('related-courses.delete')
                      <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete_re{{ $cat->id}}">
                  ...
                  <div class="modal fade bd-example-modal-sm" id="delete_re{{ $cat->id }}" tabindex="-1" role="dialog"
                    aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <div class="modal-header">
        ...
        <div class="panel panel-sum">
          <div class="modal-body">
            ...
            <select class="d-none" name="user_id" class="form-control select2">
              ...
              <div class="row">
                <div class="col-md-12">
                  <label for="exampleInputDetails">{{ __('Related Course') }}:<sup
                  ...
                  <small> {{ __('Select') }} {{ __('Related Course') }}</small>
                </div>
              </div>
              <br>
              <div class="row">
