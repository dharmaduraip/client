  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        ...
        <button type="button" class="btn btn-danger-rgba mr-2 multipledel12" data-toggle="modal" data-target="#bulk_delete12"><i
          ...
          <div class="modal-body">
            <form id="demo-form2" method="post" action="{{ route('previous-paper.store') }}" data-parsley-validate
              ...
              <div class="col-md-12 mt-2">
                <label for="">{{ __('Paper Upload') }}:<sup class="redstar">*</sup></label>
