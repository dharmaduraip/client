  ...
  <div class="col-lg-12">
    <div class="card m-b-30">
      <div class="card-header">
        @can('question.delete')
        <button type="button" class="btn btn-danger-rgba mr-2 multipledel6" data-toggle="modal" data-target="#bulk_delete6"><i
                ...
                <td>
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      ...
                      <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete_que{{ $que->id}}">
                        <i class="feather icon-delete mr-2"></i>{{ __("Delete") }}</a>
                        @endcan
                        <a class="dropdown-item" href="{{url('courseanswer/'.$que->id)}}"><i
                          class="feather icon-file-plus mr-2"></i>{{ __('Add Answer') }}</a>
                      </a>
                      <a class="dropdown-item" href="{{url('courseanswer/'.$que->id)}}"><i class="feather icon-eye mr-2"></i>{{ __('View All Answer') }}</a>
                    </div>
                  </div>
                  <div class="modal fade bd-example-modal-sm" id="delete_que{{$que->id}}" tabindex="-1" role="dialog"
                    aria-hidden="true">
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        <div class="modal-header">
