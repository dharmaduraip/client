<div class="row">
  <div class="col-lg-12">
    <div class="card m-b-30">
      ...
      <button type="button" class="btn btn-danger-rgba mr-2 multipledel8" data-toggle="modal" data-target="#bulk_delete8"><i
          ...
          <table id="" class="displaytable table table-striped table-bordered w-100">
            ...
            <tbody>
              ...
              <tr>
                ...
                <!-- ================================== -->
                <td>
                  <button type="button" class="btn btn-rounded {{ $an->status == '1' ? 'btn-success-rgba' : 'btn-danger-rgba' }}" data-toggle="modal" data-target="#myModal">
                      @if( $an->status)
                        {{ __('Active') }}
                        @else
                        {{ __('Deactive') }}
                  ...
                  <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton1">
                      @can('announcement.edit')
                        ...
                        @endcan
                        @can('announcement.delete')
                        <a class="dropdown-item btn btn-link" data-toggle="modal" data-target="#delete_an{{ $an->id}}" >
                            <i class="feather icon-delete mr-2"></i>{{ __("Delete") }}</a>
                        </a>
                        @endcan
                    </div>
                </div>
                <div class="modal fade bd-example-modal-sm" id="delete_an{{$an->id}}" tabindex="-1" role="dialog" aria-hidden="true">
                  <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                          <div class="modal-header">
