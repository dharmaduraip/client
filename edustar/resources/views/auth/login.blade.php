                    ...
                    <div class="signup-heading">
                        ...
                        <div class="signup-block">
                            ...
                            <div class="social-link btm-10">
                                <h2><span>{{ __('Or Login Using') }}</span></h2>
                                <div class="row">
                            ...
                            <div class="signin-link text-center">
                               {{ __('By signingup') }} <a href="{{url('terms_condition')}}" title="Policy">{{ __('Terms & Condition') }} </a>{{ __('and')}} <a href="{{url('privacy_policy')}}" title="Policy">{{ __('Privacy Policy') }}.</a>
                            </div>
                          </div>
                    </div>
                </div>
