...
<link rel="stylesheet" href="{{ url('css/all.css') }}" /> <!--  fontawesome css -->
{{-- <link rel="stylesheet" href="{{ url('vendor/font/flaticon.css') }}" /> --}} <!-- fontawesome css -->
<link rel="stylesheet" href="{{ url('css/menumaker.css') }}" /> <!-- navigation css -->
<link rel="stylesheet" href="{{ url('css/owl.carousel.min.css') }}" /> <!-- owl carousel css -->
<link rel="stylesheet" href="{{ url('css/protip.css') }}" /> <!-- menu css -->
