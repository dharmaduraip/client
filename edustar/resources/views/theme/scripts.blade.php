...
<script src="{{ url('js/owl.carouselrtl.min.js') }}"></script> <!-- owl carousel js -->
@else
<script src="{{ url('js/owl.carousel.min.js') }}"></script> <!-- owl carousel js -->
@endif
<script src="{{ url('js/smooth-scroll.js') }}"></script> <!-- smooth scroll js -->
<script src="{{ url('vendor/popup/jquery.magnific-popup.min.js')}}"></script> <!-- popup js-->
<script src="{{ url('js/menumaker.js') }}"></script> <!-- navigation js-->
<script src="{{ url('js/jquery.ajaxchimp.js') }}"></script> <!-- mail chimp js -->
...
<script>
  var sendurl = @json(route('autocomplete.fetch'));
</script>
  ...
  $(document).ready(function() {
    $('.business-img img').each(function(index) {
      ...
      if ($image[0].complete && $image[0].naturalWidth !== 0) {
        ...
        $image.attr('src', "{{ url('/images/breadcum/altimg.png') }}");
