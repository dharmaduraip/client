                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12">
                        <div class="navigation">
                            <div id="cssmenu">
                                <ul>
                                    <li><a href="#" title="Categories"><i data-feather="grid"></i>{{ __('Categories') }}</a>
                                       
                                        <ul>
                                            @foreach($categories as $cate)
                                            @if($cate->status == 1 )
                                            <li><a href="{{ route('category.page',['id' => $cate->id, 'category' => $cate->title]) }}" title="{{ $cate->title }}"><i class="fa {{ $cate->icon }} rgt-20"></i>{{ str_limit($cate->title, $limit = 25, $end = '..') }} 
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        @php
                            ...
                            $menu_position = App\Menu::where('status','1')->get()->pluck('position_menu');
                        @endphp
                        @if(!empty($menus) && count($menus) > 0)
                            @if(in_array("top",$menu_position->toArray()))
