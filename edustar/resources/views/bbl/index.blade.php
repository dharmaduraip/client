                            ...
                            <tbody>
								@foreach($meetings as $key=> $meeting)
									<tr>
										...
										<td>
											<p><b>Moderator {{ __('Password') }}:</b> {{ $meeting->modpw }}</p>
											<p><b>Attendee {{ __('Password') }}:</b> {{ $meeting->attendeepw }}</p>
										</td>
										...
										<td>
											<div class="dropdown">
												...
												<div class="dropdown-menu" aria-labelledby="CustomdropdownMenuButton3">
													...
													@if($meeting->is_ended != "1")
														<a class="dropdown-item"href="{{ route('api.create.meeting',$meeting->id) }}"><i class="feather icon-eye mr-2"></i>{{ __("Start Meeting")}}</a>
													@endif
												</div>
											</div>
										</td>
...
$(".multipledel").click(function(){
	...
	if(count == "0")
	{
		alert("Atleast One Meeting is required to be selected");
		return false;
	}
