...
Route::get('trans',function(){
    ...
    //     $recipients = '8438298591';
    //     $msg = 'Hey You\'r successfully enrolled in user!!';
    //     Africastalking::sendMessage($msg, $recipients);
    //     ////echo"<pre>";print_r($response->SMSMessageData);exit();
    // });
    ...
    Route::middleware(['is_active', 'auth', 'maintanance_mode'])->group(function () {
        ...
        Route::middleware(['is_admin'])->group(function () {
            ...
            Route::post('/quickupdate/featuredcourse','QuickUpdateController@featuredcourseQuicks')->name('featuredcourse.quick');
            ...
            Route::get('user/is_verifyuser','UserController@is_verifyuser')->name('is_verifyuser');
            Route::get('user/is_blockeduser','UserController@is_blockeduser')->name('is_blockeduser');
            ...
            Route::get('breadcum/setting','BreadcumController@index')->name('breadcum.setting');
            Route::post('breadcum/setting/update','BreadcumController@update')->name('breadcum.update');
            ...
            Route::get('africas_talking/settings','AfricasTalkingController@index')->name('africas_talking.settings');
            Route::post('africas_talking/update','AfricasTalkingController@update')->name('africas.talking.update');
            Route::get('africas_talking/status','AfricasTalkingController@status');
        ...
        Route::middleware(['admin_instructor', 'IsInstalled','auth'])->group(function () {
            
            Route::get('category/alertstatus', 'CategoriesController@catAlertstatus')->name('category.status.alert');
            Route::get('subcategory/alertstatus', 'SubcategoryController@catAlertstatus')->name('subcategory.status.alert');
            Route::get('childcategory/alertstatus', 'ChildcategoryController@catAlertstatus')->name('childcategory.status.alert');
            ...
            Route::get('admin/edit/objective/{id}/{tid}','QuizController@editobjective');
            Route::get('reposition/questions', 'QuizController@reposition')->name('questions_reposition');
            Route::resource('blog', 'BlogController');
            Route::resource('order', 'OrderController');
            Route::post('/order/bulk_delete','OrderController@bulk_delete');
    ...
    Route::middleware(['is_verified', '2fa', 'maintanance_mode','switch_languages'])->group(function () {
        ...
        { 
            ...
            Route::post('courseclass/detail','CourseController@courseClassPage')->name('course.class.content');
            Route::post('courseclasspos/detail','CourseController@courseClassposPage')->name('course.classpos.content');
            ...
            Route::get('batch/front/show','BatchController@front')->name('batch.front');
            Route::get('batch/frontdetail/{id}', 'BatchController@batchfront')->name('batch.frontdetail');
            ...
            Route::post('/pesapal','PesapalPaymentController@payPesapal')->name('pesapal.pay');
            Route::get('/pesapal_status','PesapalPaymentController@paymentStatus');
            ...
            Route::post('user/verifaction/store', 'UserProfileController@verifaction_store')->name('verifaction.store');  
            ...
            Route::get('/ins/{id}/{slug}', 'HomeController@instituteslug')->name('ins.sluging');
        ...
        Route::get('featuredcourse/view', 'ViewmoreController@featuredcourse')->name('featuredcourse.view');
        Route::get('bestselling/view', 'ViewmoreController@bestselling')->name('bestselling.view');
        ...
        Route::get('toprecent/view', 'ViewmoreController@toprecent')->name('toprecent.view');
