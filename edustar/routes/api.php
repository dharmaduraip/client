...
Route::get('register', 'Api\Auth\RegisterController@userregister');
...
Route::group(['middleware' => ['auth:api']], function (){
    ...
    Route::post('/pesapal','Api\PesapalPaymentController@payPesapal');
    Route::get('/pesapal_status','Api\PesapalPaymentController@paymentStatus');
