...
class Career extends Model
{
    ...
    protected $fillable = [ 
        ...
        'four_enable', 'four_img_one', 'four_img_two', 'four_img_three', 'four_img_four', 'four_img_five', 'four_img_six', 'four_img_seven', 'four_img_eight', 'four_img_nine', 'four_img_ten',
