...
class Course extends Model
{
    ...
    {
        return $this->hasMany('App\CourseChapter', 'course_id')->where('status','1');
    }
    ...
    {
        return $this->hasMany('App\CourseClass', 'course_id')->where('status','1');
    }
