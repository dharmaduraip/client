...
class RefundController extends Controller
{
    ...
    public function refundwithStripe($request, $refnd)
    {
        ...
        try
        {
            ...
            // echo "<pre>";print_r($striperefund);exit();
            RefundCourse::where('id', $refnd->id)
                    ->update([
                'status' => 1,
                'order_refund_id' => $refundrequest->id,
            ...
            return redirect('order')->with('success', trans('Refund Successful'));
        ...
        return redirect('order')->with('delete', trans('Refund Error'));
    ...
    public function refundwithRazorPay($request, $refnd)
    {
        ...
        try {
            ...
            $result = $refund->refund(array('amount' => round($refundrequest->total_amount * 100, 2)));
