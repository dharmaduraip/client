...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Session()->put('changed_language', $request->local);
   ...
   public function bulk_delete(Request $request)
   {
    ...
    public function frontstaticword($local)
    {
        ...
        if (isset($findlang))
        {
            ...
            if (file_exists(resource_path() .'/lang/' . $findlang->local . '.json'))
            {
                $file = file_get_contents(resource_path() ."/lang/$findlang->local.json");
    ...
    public function frontupdate(Request $request, $local)
    {
        ...
        if (isset($findlang))
        {
            ...
            file_put_contents(resource_path() .'/lang/'.$findlang->local.'.json', $transfile . PHP_EOL);
