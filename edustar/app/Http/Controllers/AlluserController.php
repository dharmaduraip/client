...
class AlluserController extends Controller
{
    ...
    {
        abort_if(!auth()->user()->can('Alluser.view'),403,'User does not have the right permissions.');
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    ->editColumn('image','admin.alluser.image')
                    ->editColumn('name','admin.alluser.detail')
    ...
    {
        abort_if(!auth()->user()->can('Alluser.create'),403,'User does not have the right permissions.');
    ...
    {
        abort_if(!auth()->user()->can('Alluser.edit'),403,'User does not have the right permissions.');
    ...
    {
        abort_if(!auth()->user()->can('Alluser.delete'),403,'User does not have the right permissions.');
    ...
    {
        abort_if(!auth()->user()->can('Alluser.update'),403,'User does not have the right permissions.');
