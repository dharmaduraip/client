...
class MarketController extends Controller
{
    ...
    public function index(){
        ...
        $order_total = array(
            ...
            $order          =       Order::select('user_id')->groupBy('user_id')->get();
            ...
            $admin_course_val=       DB::table('orders')->where('instructor_id',Auth::user()->id)->sum('total_amount');
            $admin_total    =       $admin_amount + $admin_payment + $admin_course_val;
            $course         =       Course::count();
