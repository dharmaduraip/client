...
class BigBlueController extends Controller
{
    ...
    public function index(){
        $meetings = BBL::orderBy('id','DESC')->where('instructor_id',Auth::user()->id)->get();
        // echo"<pre>";print_r($meetings->toArray());exit();
    ...
    public function update(Request $request,$id){
        ...
        return redirect()->route('bbl.all.meeting')->with('success',trans('flash.Updated Successfully'));
    }
    ...
    public function getrecordings(Request $request)
    {
        if(env('BBB_SECURITY_SALT') != NULL  && env('BBB_SERVER_BASE_URL') != NULL){
            ...
            if ($response->getReturnCode() == 'SUCCESS') {
                ...
                return view('bbl.setting')->with('delete','Recordings not found !');
        ...
        return view('bbl.setting')->with('delete','Update your settings !');
