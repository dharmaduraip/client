...
class CareersController extends Controller
{
    public function __construct()
    {
        ...
        $this->middleware('permission:career.manage', ['only' => ['show', 'update']]);
    }
    ...
    public function update(Request $request)
    {
        ...
        if (isset($data)) {
            ...
            if ($file = $request->file('one_video')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->one_video);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('three_bg_image')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->three_bg_image);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('three_video')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->three_video);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_one')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_one);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_two')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_two);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_three')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_three);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_four')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_four);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_five')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_five);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_six')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_six);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_seven')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_seven);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_eight')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_eight);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
            ...
            if ($file = $request->file('four_img_nine')) {
                ...
                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_nine);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
                $input['four_img_nine'] = $name;
            }
            if ($file = $request->file('four_img_ten')) {
                $image_file = @file_get_contents(public_path() . '/images/careers/' . $data->four_img_ten);

                if ($image_file) {
                    unlink(public_path() . '/images/careers/' . $data->four_img_ten);
                }
                $name = time() . $file->getClientOriginalName();
                $file->move(public_path() . '/images/careers', $name);
                $input['four_img_ten'] = $name;
            }
