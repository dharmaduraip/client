...
class MainController extends Controller
{
    ...
    public function updateprofile(Request $request)
    {
        ...
        if (Hash::check($request->current_password, $auth->password)) {
            ...
            $auth->update([
                ...
                'iso_code' => isset($input['iso_code']) ? $input['iso_code'] : $auth->iso_code,
                'phone_code' => isset($input['phone_code']) ? $input['phone_code'] : $auth->phone_code,
    ...
    public function terms(Request $request)
    {
        ...
        if(count($terms_policy) > 0 )
        {
            return response()->json(array('terms_policy' => $terms_policy), 200);
        }
        else
        {
            return response()->json(array('terms_policy' => "No data found!!"), 200);
        }
    }
