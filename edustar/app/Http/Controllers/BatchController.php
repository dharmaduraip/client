...
class BatchController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            'title' => 'required',
            'detail' => 'required',
            'preview_image' => 'mimes:jpeg,jpg,png|required|',
    ...
    public function show($id)
    {
        ...
        $users = Order::with('user')->with('courses')->groupBy('user_id')->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        $request->validate([
            'title' => 'required',
            'detail' => 'required',
            'preview_image' => 'mimes:jpeg,jpg,png',
            'allowed_courses' => 'required',
        ]);
    ...
    public function batchdeleteAll(Request $request)
        ...
        public function front(){
            ...
            {
                if (in_array(Auth::user()->id, $batch->allowed_users))
                {
                    $data[] = $batch;
                }
            }
        ...
        public function batchfront(Request $request, $id){

            $data = Batch::where('id',$request->id)->get();
