...
class AboutController extends Controller
{
    ...
    {
        $request->validate([
            'one_image' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'two_imageone' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'two_imagetwo' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'two_imagethree' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'two_imagefour' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'four_imageone' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'four_imagetwo' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'five_imageone' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'five_imagetwo' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
            'five_imagethree' => 'mimes:jpeg,png,jpg,gif,svg|max:2048',
        ]);
    	$about = About::first();
        ...
        if(isset($about))
        {
            ...
            if ($file = $request->file('one_image'))
            {
                if($about->one_image != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->one_image);
                    }
                }  
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('two_imageone'))
            {
                if($about->two_imageone != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->two_imageone);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('two_imagetwo'))
            {
                if($about->two_imagetwo != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->two_imagetwo);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('two_imagethree'))
            {
                if($about->two_imagethree != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->two_imagethree);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('two_imagefour'))
            {
                if($about->two_imagefour != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->two_imagefour);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('four_imageone'))
            {
                if($about->four_imageone != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->four_imageone);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('four_imagetwo'))
            {
                if($about->four_imagetwo != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->four_imagetwo);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('five_imageone'))
            {
                if($about->five_imageone != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->five_imageone);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('five_imagetwo'))
            {
                if($about->five_imagetwo != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->five_imagetwo);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
            ...
            if ($file = $request->file('five_imagethree'))
            {
                if($about->five_imagethree != "")
                {
                    ...
                    if($image_file)
                    {
                        unlink(public_path().'/images/about/'.$about->five_imagethree);
                    }
                }
                $name = time().$file->getClientOriginalName();
                $file->move(public_path().'/images/about', $name);
