...
class UserProfileController extends Controller
{
    public function userprofilepage($id)
    {
        if(Auth::check())
        {
            ...
            $states = Allstate::where('country_id',$orders->country_id)->get();
            $cities = Allcity::where('state_id',$orders->state_id)->get();
    ...
    public function userprofile(Request $request,$id)
    {
        ...
        if($file = $request->file('user_img'))
        {
            ...
            $file->move(public_path().'/images/user_img', $name);
            $input['user_img'] = $name;
        }
        ...
        Session::flash('success', trans('flash.updated_successfully'));
        return back();
    }
    ...
    public function leaderboard()
    {
        ...
        {
            $total_clas = $progress->all_chapter_id;
            $total_clas =  count($total_clas);
            $total_class += $total_clas;
        ...
        if($total_mark != 0)
        {
          $progres = ($total_mark/$total_class) * 100;
