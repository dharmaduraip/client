...
class AllinstructorController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.allinstructor.adduser')->with(['cities' => $cities, 'states' => $states, 'countries' => $countries]);
    }
    ...
    {
        abort_if(!auth()->user()->can('Allinstructor.edit'),403,'User does not have the right permissions.');
        $cities = City::all();
        $states = State::all();
        ...
        return view('admin.allinstructor.edit',compact('cities','states','countries','user'));
    ...
    {
        abort_if(!auth()->user()->can('Allinstructor.delete'),403,'User does not have the right permissions.');
        $user = User::find($id);
    ...
    {
        abort_if(!auth()->user()->can('Allinstructor.update'),403,'User does not have the right permissions.');
