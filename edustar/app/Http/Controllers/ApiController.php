...
class ApiController extends Controller
{
    ...
    public function changeEnvKeys(Request $request)
    {
        ...
        $addenv_keys = DotenvEditor::setKeys([
            ...
            'PESAPAL_CONSUMER_KEY' => $input['PESAPAL_CONSUMER_KEY'],
            'PESAPAL_CONSUMER_SECRET' => $input['PESAPAL_CONSUMER_SECRET'],
            'PESAPAL_MODE' => $input['PESAPAL_MODE'],
        ...
        if (isset($request->pesapal_enable)) {
            $setting->pesapal_enable = "1";
        } else {
            $setting->pesapal_enable = "0";
        }
